...
slug: "openfoam-v14-file-00681d252028"
...
source_path: "src/Pstream/dummy/UIPread.C"
...
- 源码路径：`src/Pstream/dummy/UIPread.C`
- 功能分类：并行与域分解
- 文件类型：C/C++ 或词法/语法源文件
- 规模：101 行
- 文件标识：`00681d252028`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::UIPstream::UIPstream` | 65 |
| `Foam::UIPstream::read` | 84 |
