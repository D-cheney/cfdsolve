...
slug: "openfoam-v14-file-f13b4aac95b8"
title: "OpenFOAM 14 源码解析：lagrangianFieldReconstructor.H"
summary: "该文件声明或实现 `IOobjectList`、`passiveParticleCloud`、`lagrangianFieldReconstructor`、`IOContainer`，属于“并行与域分解”模块。"
...
该文件声明或实现 `IOobjectList`、`passiveParticleCloud`、`lagrangianFieldReconstructor`、`IOContainer`，属于“并行与域分解”模块。
...
- [`lagrangianFieldReconstructorTemplates.C`](../../../13-parallel/files/30/lagrangianfieldreconstructortemplates.c--308d8f1d9460.md)
