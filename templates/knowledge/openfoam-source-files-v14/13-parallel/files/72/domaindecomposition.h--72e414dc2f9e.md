...
slug: "openfoam-v14-file-72e414dc2f9e"
title: "OpenFOAM 14 源码解析：domainDecomposition.H"
summary: "该文件声明或实现 `faceCoupleInfo`、`multiDomainDecomposition`、`cellSet`、`faceSet`，属于“并行与域分解”模块。"
...
source_path: "src/parallel/parallel/domainDecomposition/domainDecomposition.H"
tags: [OpenFOAM14, 源码解析, 并行与域分解]
---

# OpenFOAM 14 源码解析：domainDecomposition.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/parallel/parallel/domainDecomposition/domainDecomposition.H`
- 功能分类：并行与域分解
- 文件类型：C/C++ 或词法/语法源文件
- 规模：578 行
- 文件标识：`72e414dc2f9e`
...
该文件声明或实现 `faceCoupleInfo`、`multiDomainDecomposition`、`cellSet`、`faceSet`，属于“并行与域分解”模块。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Engine for decomposing and reconstructing finite-volume meshes
...
|---|---:|
| `faceCoupleInfo` | 57 |
| `multiDomainDecomposition` | 59 |
| `cellSet` | 60 |
| `faceSet` | 61 |
| `pointSet` | 62 |
| `domainDecomposition` | 67 |
