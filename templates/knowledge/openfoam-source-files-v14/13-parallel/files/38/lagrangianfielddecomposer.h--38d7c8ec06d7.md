...
slug: "openfoam-v14-file-38d7c8ec06d7"
title: "OpenFOAM 14 源码解析：lagrangianFieldDecomposer.H"
summary: "该文件声明或实现 `IOobjectList`、`passiveParticleCloud`、`lagrangianFieldDecomposer`、`IOContainer`，属于“并行与域分解”模块。"
...
该文件声明或实现 `IOobjectList`、`passiveParticleCloud`、`lagrangianFieldDecomposer`、`IOContainer`，属于“并行与域分解”模块。
...
- [`lagrangianFieldDecomposerTemplates.C`](../../../13-parallel/files/fb/lagrangianfielddecomposertemplates.c--fbf86d758537.md)
