...
slug: "openfoam-v14-file-308d8f1d9460"
title: "OpenFOAM 14 源码解析：lagrangianFieldReconstructorTemplates.C"
summary: "该文件声明或实现 `IOContainer`，属于“并行与域分解”模块。"
...
该文件声明或实现 `IOContainer`，属于“并行与域分解”模块。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::lagrangianFieldReconstructor::reconstructs` | 38 |
| `Foam::lagrangianFieldReconstructor::reconstructFields` | 63 |
| `Foam::lagrangianFieldReconstructor::reconstructField` | 107 |
...
- [src/parallel/parallel/fieldReconstructors/lagrangianFieldReconstructor/lagrangianFieldReconstructor.H](../../../13-parallel/files/f1/lagrangianfieldreconstructor.h--f13b4aac95b8.md)
