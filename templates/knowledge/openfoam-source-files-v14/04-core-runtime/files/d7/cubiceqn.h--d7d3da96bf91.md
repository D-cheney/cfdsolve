...
slug: "openfoam-v14-file-d7d3da96bf91"
title: "OpenFOAM 14 源码解析：cubicEqn.H"
summary: "该文件声明或实现 `cubicEqn`、`coefficient`，属于“核心运行时”模块。"
...
source_path: "src/OpenFOAM/primitives/polynomialEqns/cubicEqn/cubicEqn.H"
tags: [OpenFOAM14, 源码解析, 核心运行时]
---

# OpenFOAM 14 源码解析：cubicEqn.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/OpenFOAM/primitives/polynomialEqns/cubicEqn/cubicEqn.H`
- 功能分类：核心运行时
- 文件类型：C/C++ 或词法/语法源文件
- 规模：129 行
- 文件标识：`d7d3da96bf91`
...
该文件声明或实现 `cubicEqn`、`coefficient`，属于“核心运行时”模块。

中文导航角色：OpenFOAM 核心基础设施。

上游说明：Cubic equation of the form a*x^3 + b*x^2 + c*x + d = 0
...
- [`cubicEqnI.H`](../../../04-core-runtime/files/c2/cubiceqni.h--c2f1e3ab74b7.md)
...
- [src/OpenFOAM/primitives/Tensor/tensor/tensor.C](../../../04-core-runtime/files/d1/tensor.c--d146134a247f.md)
