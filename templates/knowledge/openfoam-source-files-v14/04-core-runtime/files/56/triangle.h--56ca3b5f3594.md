...
slug: "openfoam-v14-file-56ca3b5f3594"
title: "OpenFOAM 14 源码解析：triangle.H"
summary: "该文件声明或实现 `Istream`、`Ostream`、`triangle`，属于“核心运行时”模块。"
...
source_path: "src/OpenFOAM/meshes/primitiveShapes/triangle/triangle.H"
tags: [OpenFOAM14, 源码解析, 核心运行时]
---

# OpenFOAM 14 源码解析：triangle.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/OpenFOAM/meshes/primitiveShapes/triangle/triangle.H`
- 功能分类：核心运行时
- 文件类型：C/C++ 或词法/语法源文件
- 规模：281 行
- 文件标识：`56ca3b5f3594`
...
该文件声明或实现 `Istream`、`Ostream`、`triangle`，属于“核心运行时”模块。

中文导航角色：OpenFOAM 核心基础设施。

上游说明：A triangle primitive used to calculate face areas and swept volumes.
...
- [`triangleI.H`](../../../04-core-runtime/files/b4/trianglei.h--b49c2ad57538.md)
...
- [src/OpenFOAM/meshes/primitiveShapes/triangle/triPointRef.H](../../../04-core-runtime/files/b0/tripointref.h--b095b5632b50.md)
