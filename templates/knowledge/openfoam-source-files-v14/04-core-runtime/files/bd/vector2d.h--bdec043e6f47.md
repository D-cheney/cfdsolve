...
slug: "openfoam-v14-file-bdec043e6f47"
title: "OpenFOAM 14 源码解析：vector2D.H"
summary: "该文件为“核心运行时”提供 `vector2D` 相关接口、模板实例或支撑定义。"
...
source_path: "src/OpenFOAM/primitives/Vector2D/vector2D/vector2D.H"
...
- 源码路径：`src/OpenFOAM/primitives/Vector2D/vector2D/vector2D.H`
- 功能分类：核心运行时
- 文件类型：C/C++ 或词法/语法源文件
- 规模：71 行
- 文件标识：`bdec043e6f47`
...
该文件为“核心运行时”提供 `vector2D` 相关接口、模板实例或支撑定义。

中文导航角色：OpenFOAM 核心基础设施。

上游说明：vector2D obtained from generic Vector2D
...
- [src/OpenFOAM/fields/vector2DField/vector2DFieldFwd.H](../../../04-core-runtime/files/fd/vector2dfieldfwd.h--fdcbf59e5859.md)
...
- [src/OpenFOAM/meshes/primitiveShapes/point2D/point2D.H](../../../04-core-runtime/files/9e/point2d.h--9e0182ac6e40.md)
...
- [src/OpenFOAM/primitives/Vector2D/vector2D/vector2D.C](../../../04-core-runtime/files/66/vector2d.c--664b837b3297.md)
