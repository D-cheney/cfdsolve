...
slug: "openfoam-v14-file-722cf0d3475a"
...
source_path: "src/OpenFOAM/primitives/Barycentric2D/barycentric2D/barycentric2D.H"
...
- 源码路径：`src/OpenFOAM/primitives/Barycentric2D/barycentric2D/barycentric2D.H`
- 功能分类：核心运行时
- 文件类型：C/C++ 或词法/语法源文件
- 规模：78 行
- 文件标识：`722cf0d3475a`
...
上游说明：A scalar version of the templated Barycentric2D
...
- [src/OpenFOAM/primitives/Barycentric2D/barycentric2D/barycentric2D.C](../../../04-core-runtime/files/66/barycentric2d.c--66be9c747500.md)
