...
slug: "openfoam-v14-file-f04294ee15a1"
title: "OpenFOAM 14 源码解析：pointHit.H"
summary: "该文件为“核心运行时”提供 `pointHit` 相关接口、模板实例或支撑定义。"
...
该文件为“核心运行时”提供 `pointHit` 相关接口、模板实例或支撑定义。
...
- [src/OpenFOAM/meshes/primitiveShapes/objectHit/pointHitSort.H](../../../04-core-runtime/files/48/pointhitsort.h--486de8e3f384.md)
...
- [src/OpenFOAM/meshes/primitiveShapes/triangle/triangleI.H](../../../04-core-runtime/files/b4/trianglei.h--b49c2ad57538.md)
