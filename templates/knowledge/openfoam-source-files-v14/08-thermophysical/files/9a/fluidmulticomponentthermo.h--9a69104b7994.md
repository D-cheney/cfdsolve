...
slug: "openfoam-v14-file-9a69104b7994"
...
上游说明：Fluid multi-component thermo implementation

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `FluidMulticomponentThermo` | 54 |
...
- [`FluidMulticomponentThermo.C`](../../../08-thermophysical/files/e8/fluidmulticomponentthermo.c--e87627289d91.md)

## 8. 直接上层引用

- [src/thermophysicalModels/multicomponentThermo/fluidMulticomponentThermo/FluidMulticomponentThermo.C](../../../08-thermophysical/files/e8/fluidmulticomponentthermo.c--e87627289d91.md)
