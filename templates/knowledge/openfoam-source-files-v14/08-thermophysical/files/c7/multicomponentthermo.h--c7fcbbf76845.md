...
slug: "openfoam-v14-file-c7fcbbf76845"
title: "OpenFOAM 14 源码解析：MulticomponentThermo.H"
summary: "该文件声明或实现 `MulticomponentThermo`，属于“热物性与反应”模块。"
...
该文件声明或实现 `MulticomponentThermo`，属于“热物性与反应”模块。

中文导航角色：热力学与物性模型。

上游说明：Multi-component thermo implementation
...
- [`MulticomponentThermo.C`](../../../08-thermophysical/files/7f/multicomponentthermo.c--7fea310179c6.md)

## 8. 直接上层引用

- [src/thermophysicalModels/multicomponentThermo/multicomponentThermo/MulticomponentThermo.C](../../../08-thermophysical/files/7f/multicomponentthermo.c--7fea310179c6.md)
