...
slug: "openfoam-v14-file-79190d9dd27f"
title: "OpenFOAM 14 源码解析：wedgePointPatch.H"
summary: "该文件声明或实现 `wedgePointPatch`，属于“有限体积离散”模块。"
...
source_path: "src/finiteVolume/pointMesh/pointPatches/constraint/wedge/wedgePointPatch.H"
tags: [OpenFOAM14, 源码解析, 有限体积离散]
---

# OpenFOAM 14 源码解析：wedgePointPatch.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/finiteVolume/pointMesh/pointPatches/constraint/wedge/wedgePointPatch.H`
- 功能分类：有限体积离散
- 文件类型：C/C++ 或词法/语法源文件
- 规模：107 行
- 文件标识：`79190d9dd27f`
...
该文件声明或实现 `wedgePointPatch`，属于“有限体积离散”模块。
