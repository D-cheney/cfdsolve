...
slug: "openfoam-v14-file-e7cde74fcc49"
...
上游说明：Calculate the substantive (total) derivative.
...
- [`fvcDDt.C`](../../../05-finite-volume/files/52/fvcddt.c--52a1c203dcb2.md)

## 8. 直接上层引用

- [src/finiteVolume/finiteVolume/fvc/fvc.H](../../../05-finite-volume/files/01/fvc.h--0156a3676734.md)
- [src/finiteVolume/finiteVolume/fvc/fvcDDt.C](../../../05-finite-volume/files/52/fvcddt.c--52a1c203dcb2.md)
