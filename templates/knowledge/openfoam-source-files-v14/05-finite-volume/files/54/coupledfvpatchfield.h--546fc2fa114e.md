...
slug: "openfoam-v14-file-546fc2fa114e"
title: "OpenFOAM 14 源码解析：coupledFvPatchField.H"
summary: "该文件声明或实现 `coupledFvPatchField`，属于“有限体积离散”模块。"
...
source_path: "src/finiteVolume/fields/fvPatchFields/basic/coupled/coupledFvPatchField.H"
tags: [OpenFOAM14, 源码解析, 有限体积离散]
---

# OpenFOAM 14 源码解析：coupledFvPatchField.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/finiteVolume/fields/fvPatchFields/basic/coupled/coupledFvPatchField.H`
- 功能分类：有限体积离散
- 文件类型：C/C++ 或词法/语法源文件
- 规模：261 行
- 文件标识：`546fc2fa114e`
...
该文件声明或实现 `coupledFvPatchField`，属于“有限体积离散”模块。

中文导航角色：有限体积离散核心。

上游说明：Abstract base class for coupled patches.

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `coupledFvPatchField` | 56 |
...
- [`LduInterfaceField.H`](../../../06-linear-algebra/files/19/lduinterfacefield.h--19bf5e2aa209.md)
...
- [`coupledFvPatchField.C`](../../../05-finite-volume/files/fb/coupledfvpatchfield.c--fbc0fc3c56de.md)

## 8. 直接上层引用

- [src/finiteVolume/fields/fvPatchFields/basic/coupled/coupledFvPatchField.C](../../../05-finite-volume/files/fb/coupledfvpatchfield.c--fbc0fc3c56de.md)
