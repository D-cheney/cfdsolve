...
slug: "openfoam-v14-file-d32a079c3240"
title: "OpenFOAM 14 源码解析：fvcGrad.H"
summary: "该文件为“有限体积离散”提供 `fvcGrad` 相关接口、模板实例或支撑定义。"
...
source_path: "src/finiteVolume/finiteVolume/fvc/fvcGrad.H"
tags: [OpenFOAM14, 源码解析, 有限体积离散]
---

# OpenFOAM 14 源码解析：fvcGrad.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/finiteVolume/finiteVolume/fvc/fvcGrad.H`
- 功能分类：有限体积离散
- 文件类型：C/C++ 或词法/语法源文件
- 规模：119 行
- 文件标识：`d32a079c3240`
...
该文件为“有限体积离散”提供 `fvcGrad` 相关接口、模板实例或支撑定义。

中文导航角色：有限体积离散核心。

上游说明：Calculate the gradient of the given field.
...
- [`fvcGrad.C`](../../../05-finite-volume/files/f9/fvcgrad.c--f92cc2a7c652.md)
...
- [applications/modules/multiphaseEuler/fvModels/interfaceTurbulenceDamping/interfaceTurbulenceDamping.C](../../../02-solver-modules/files/fc/interfaceturbulencedamping.c--fcab85e5c3e6.md)
...
- [applications/modules/multiphaseEuler/phaseSystem/interfacialModels/liftModels/LegendreMagnaudet/LegendreMagnaudet.C](../../../02-solver-modules/files/dc/legendremagnaudet.c--dc15b728599b.md)
- [applications/modules/multiphaseEuler/phaseSystem/interfacialModels/liftModels/Moraga/Moraga.C](../../../02-solver-modules/files/ca/moraga.c--caccf95525e6.md)
