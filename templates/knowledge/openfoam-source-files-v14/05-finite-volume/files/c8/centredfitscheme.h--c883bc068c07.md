...
slug: "openfoam-v14-file-c883bc068c07"
title: "OpenFOAM 14 源码解析：CentredFitScheme.H"
summary: "该文件实现 `CentredFitScheme` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/finiteVolume/interpolation/surfaceInterpolation/schemes/CentredFitScheme/CentredFitScheme.H"
tags: [OpenFOAM14, 源码解析, 有限体积离散]
---

# OpenFOAM 14 源码解析：CentredFitScheme.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/finiteVolume/interpolation/surfaceInterpolation/schemes/CentredFitScheme/CentredFitScheme.H`
- 功能分类：有限体积离散
- 文件类型：C/C++ 或词法/语法源文件
- 规模：196 行
- 文件标识：`c883bc068c07`
...
该文件实现 `CentredFitScheme` 的运行时工厂选择，根据类型名创建具体实现。

中文导航角色：有限体积离散核心。

上游说明：Centred fit surface interpolation scheme which applies an explicit correction to linear.
...
- [`CentredFitData.H`](../../../05-finite-volume/files/df/centredfitdata.h--dffa7d5d4fde.md)
- `linear.H`
