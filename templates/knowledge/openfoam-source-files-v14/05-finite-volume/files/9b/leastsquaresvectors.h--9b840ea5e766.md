...
slug: "openfoam-v14-file-9b840ea5e766"
title: "OpenFOAM 14 源码解析：LeastSquaresVectors.H"
summary: "该文件实现 `LeastSquaresVectors` 的运行时工厂选择，根据类型名创建具体实现。"
...
该文件实现 `LeastSquaresVectors` 的运行时工厂选择，根据类型名创建具体实现。
...
- [`LeastSquaresVectors.C`](../../../05-finite-volume/files/82/leastsquaresvectors.c--82cbbfe4f4b2.md)
...
- [src/finiteVolume/finiteVolume/gradSchemes/LeastSquaresGrad/LeastSquaresVectors.C](../../../05-finite-volume/files/82/leastsquaresvectors.c--82cbbfe4f4b2.md)
