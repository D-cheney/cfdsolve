...
slug: "openfoam-v14-file-8b22c76f5a55"
title: "OpenFOAM 14 源码解析：fvMeshStitcher.H"
summary: "该文件声明或实现 `nonConformalCyclicFvPatch`、`nonConformalMappedWallFvPatch`、`fvMeshStitcher`、`GeoField`，属于“有限体积离散”模块。"
...
source_path: "src/finiteVolume/fvMesh/fvMeshStitchers/fvMeshStitcher/fvMeshStitcher.H"
tags: [OpenFOAM14, 源码解析, 有限体积离散]
---

# OpenFOAM 14 源码解析：fvMeshStitcher.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/finiteVolume/fvMesh/fvMeshStitchers/fvMeshStitcher/fvMeshStitcher.H`
- 功能分类：有限体积离散
- 文件类型：C/C++ 或词法/语法源文件
- 规模：523 行
- 文件标识：`8b22c76f5a55`
...
该文件声明或实现 `nonConformalCyclicFvPatch`、`nonConformalMappedWallFvPatch`、`fvMeshStitcher`、`GeoField`，属于“有限体积离散”模块。

中文导航角色：有限体积离散核心。

上游说明：Mesh manipulator that uses the intersection provided by the cyclic non-conformal poly patches to create non-conformal finite volume interfaces.

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `nonConformalCyclicFvPatch` | 54 |
| `nonConformalMappedWallFvPatch` | 56 |
| `fvMeshStitcher` | 61 |
| `GeoField` | 331 |
...
- [`fvMeshStitcherTemplates.C`](../../../05-finite-volume/files/85/fvmeshstitchertemplates.c--857a1e001e1b.md)
...
- [src/finiteVolume/fvMesh/fvMeshStitchers/fvMeshStitcher/fvMeshStitcherNew.C](../../../05-finite-volume/files/c2/fvmeshstitchernew.c--c22d958ee872.md)
...
- [src/finiteVolume/fvMesh/fvMeshStitchers/stationary/stationary_fvMeshStitcher.H](../../../05-finite-volume/files/b7/stationary_fvmeshstitcher.h--b76337d6e000.md)
...
- [src/fvMeshStitchers/moving/moving_fvMeshStitcher.H](../../../17-other-libraries/files/59/moving_fvmeshstitcher.h--591ebfb5c294.md)
