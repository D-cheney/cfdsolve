...
slug: "openfoam-v14-file-61749ad53c94"
title: "OpenFOAM 14 源码解析：primitiveTriPatch.H"
summary: "该文件为“网格与几何”提供 `primitiveTriPatch` 相关接口、模板实例或支撑定义。"
...
source_path: "src/meshTools/patchIntersection/primitiveTriPatch.H"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：primitiveTriPatch.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/meshTools/patchIntersection/primitiveTriPatch.H`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：55 行
- 文件标识：`61749ad53c94`
...
该文件为“网格与几何”提供 `primitiveTriPatch` 相关接口、模板实例或支撑定义。
