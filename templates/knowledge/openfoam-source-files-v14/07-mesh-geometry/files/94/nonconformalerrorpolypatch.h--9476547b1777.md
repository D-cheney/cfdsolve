...
slug: "openfoam-v14-file-9476547b1777"
title: "OpenFOAM 14 源码解析：nonConformalErrorPolyPatch.H"
summary: "该文件声明或实现 `nonConformalCyclicPolyPatch`、`nonConformalErrorPolyPatch`，属于“网格与几何”模块。"
...
source_path: "src/meshTools/nonConformal/polyPatches/nonConformalError/nonConformalErrorPolyPatch.H"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：nonConformalErrorPolyPatch.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/meshTools/nonConformal/polyPatches/nonConformalError/nonConformalErrorPolyPatch.H`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：197 行
- 文件标识：`9476547b1777`
...
该文件声明或实现 `nonConformalCyclicPolyPatch`、`nonConformalErrorPolyPatch`，属于“网格与几何”模块。
...
| 名称 | 源码行 |
|---|---:|
| `nonConformalCyclicPolyPatch` | 58 |
| `nonConformalErrorPolyPatch` | 64 |
