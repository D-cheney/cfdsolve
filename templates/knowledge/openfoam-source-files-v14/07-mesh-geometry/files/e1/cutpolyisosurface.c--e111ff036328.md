...
slug: "openfoam-v14-file-e111ff036328"
title: "OpenFOAM 14 源码解析：cutPolyIsoSurface.C"
summary: "该文件实现 `cutPolyIsoSurface` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/meshTools/cutPoly/cutPolyIsoSurface.C"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：cutPolyIsoSurface.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/meshTools/cutPoly/cutPolyIsoSurface.C`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：242 行
- 文件标识：`e111ff036328`
...
该文件实现 `cutPolyIsoSurface` 的运行时工厂选择，根据类型名创建具体实现。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::cutPolyIsoSurface::cutPolyIsoSurface` | 183 |
