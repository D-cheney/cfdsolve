...
slug: "openfoam-v14-file-7d3b13bf40b0"
title: "OpenFOAM 14 源码解析：extendedEdgeMeshTemplates.C"
...
source_path: "src/meshTools/edgeMesh/extendedEdgeMesh/extendedEdgeMeshTemplates.C"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：extendedEdgeMeshTemplates.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/meshTools/edgeMesh/extendedEdgeMesh/extendedEdgeMeshTemplates.C`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：423 行
- 文件标识：`7d3b13bf40b0`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::extendedEdgeMesh::sortPointsAndEdges` | 39 |
