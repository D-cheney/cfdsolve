...
slug: "openfoam-v14-file-7dffdfb07b26"
title: "OpenFOAM 14 源码解析：repatchMesh.H"
summary: "该文件声明或实现 `polyMesh`、`primitiveMesh`、`repatchMesh`，属于“网格与几何”模块。"
...
source_path: "src/polyTopoChange/repatchMesh/repatchMesh.H"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：repatchMesh.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/polyTopoChange/repatchMesh/repatchMesh.H`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：310 行
- 文件标识：`7dffdfb07b26`
...
该文件声明或实现 `polyMesh`、`primitiveMesh`、`repatchMesh`，属于“网格与几何”模块。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Addressing for all faces on surface of mesh. Can either be read from polyMesh or from triSurface. Used for repatching existing meshes.
...
- [`repatchPatch.H`](../../../07-mesh-geometry/files/fb/repatchpatch.h--fb8fdce6945f.md)
