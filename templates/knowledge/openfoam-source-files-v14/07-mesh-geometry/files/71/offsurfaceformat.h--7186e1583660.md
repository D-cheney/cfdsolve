...
slug: "openfoam-v14-file-7186e1583660"
title: "OpenFOAM 14 源码解析：OFFsurfaceFormat.H"
summary: "该文件声明或实现 `OFFsurfaceFormat`，属于“网格与几何”模块。"
...
source_path: "src/surfMesh/surfaceFormats/off/OFFsurfaceFormat.H"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：OFFsurfaceFormat.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/surfMesh/surfaceFormats/off/OFFsurfaceFormat.H`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：140 行
- 文件标识：`7186e1583660`
...
该文件声明或实现 `OFFsurfaceFormat`，属于“网格与几何”模块。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Provide a means of reading/writing Geomview OFF polyList format.
...
- [`OFFsurfaceFormat.C`](../../../07-mesh-geometry/files/e2/offsurfaceformat.c--e2e1579448c5.md)
