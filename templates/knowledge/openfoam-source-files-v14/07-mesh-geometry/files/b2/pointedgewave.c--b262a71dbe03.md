...
slug: "openfoam-v14-file-b262a71dbe03"
title: "OpenFOAM 14 源码解析：PointEdgeWave.C"
summary: "该文件声明或实现 `combineEqOp`，属于“网格与几何”模块。"
...
source_path: "src/meshTools/algorithms/PointEdgeWave/PointEdgeWave.C"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：PointEdgeWave.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/meshTools/algorithms/PointEdgeWave/PointEdgeWave.C`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：910 行
- 文件标识：`b262a71dbe03`
...
该文件声明或实现 `combineEqOp`，属于“网格与几何”模块。
