...
slug: "openfoam-v14-file-34d93eb3df28"
title: "OpenFOAM 14 源码解析：layerParameters.H"
summary: "该文件声明或实现 `polyBoundaryMesh`、`refinementSurfaces`、`layerParameters`，属于“网格与几何”模块。"
...
source_path: "src/mesh/snappyHexMesh/snappyHexMeshDriver/layerParameters/layerParameters.H"
tags: [OpenFOAM14, 源码解析, 网格与几何]
---

# OpenFOAM 14 源码解析：layerParameters.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/mesh/snappyHexMesh/snappyHexMeshDriver/layerParameters/layerParameters.H`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：370 行
- 文件标识：`34d93eb3df28`
...
该文件声明或实现 `polyBoundaryMesh`、`refinementSurfaces`、`layerParameters`，属于“网格与几何”模块。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Simple container to keep together layer specific information.
...
| `concaveAngle` | 273 |
| `nGrow` | 282 |
| `maxFaceThicknessRatio` | 288 |
| `nBufferCellsNoExtrude` | 294 |
