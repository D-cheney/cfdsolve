...
slug: "openfoam-v14-file-0e479bed3dde"
title: "OpenFOAM 14 源码解析：checkMesh.C"
summary: "该文件实现 `checkMesh` 等过程，属于“网格与几何”模块。"
...
source_path: "src/meshCheck/checkMesh.C"
...
- 源码路径：`src/meshCheck/checkMesh.C`
- 功能分类：网格与几何
- 文件类型：C/C++ 或词法/语法源文件
- 规模：397 行
- 文件标识：`0e479bed3dde`
...
该文件实现 `checkMesh` 等过程，属于“网格与几何”模块。
