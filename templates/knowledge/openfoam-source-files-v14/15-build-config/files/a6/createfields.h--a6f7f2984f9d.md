...
slug: "openfoam-v14-file-a6f7f2984f9d"
title: "OpenFOAM 14 源码解析：createFields.H"
summary: "该文件为“构建与配置”提供 `createFields` 相关接口、模板实例或支撑定义。"
...
source_path: "etc/codeTemplates/app/createFields.H"
...
- 源码路径：`etc/codeTemplates/app/createFields.H`
- 功能分类：构建与配置
- 文件类型：C/C++ 或词法/语法源文件
- 规模：20 行
- 文件标识：`a6f7f2984f9d`
...
该文件为“构建与配置”提供 `createFields` 相关接口、模板实例或支撑定义。
