...
slug: "openfoam-v14-file-eb28b134687a"
title: "OpenFOAM 14 源码解析：probesTemplates.C"
summary: "该文件实现 `probesTemplates` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/sampling/probes/probesTemplates.C"
tags: [OpenFOAM14, 源码解析, 功能对象与采样]
---

# OpenFOAM 14 源码解析：probesTemplates.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/sampling/probes/probesTemplates.C`
- 功能分类：功能对象与采样
- 文件类型：C/C++ 或词法/语法源文件
- 规模：277 行
- 文件标识：`eb28b134687a`
...
该文件实现 `probesTemplates` 的运行时工厂选择，根据类型名创建具体实现。
...
|---|---:|
| `operator` | 47 |
| `Foam::probes::sampleAndWrite` | 71 |
| `Foam::probes::sampleAndWriteSurfaceFields` | 141 |
| `Foam::probes::sample` | 166 |
| `Foam::probes::sampleSurfaceFields` | 261 |
