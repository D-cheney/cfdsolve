...
slug: "openfoam-v14-file-c407278a704a"
title: "OpenFOAM 14 源码解析：streamlines.C"
summary: "该文件实现 `streamlines` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/functionObjects/field/streamlines/streamlines.C"
tags: [OpenFOAM14, 源码解析, 功能对象与采样]
---

# OpenFOAM 14 源码解析：streamlines.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/functionObjects/field/streamlines/streamlines.C`
- 功能分类：功能对象与采样
- 文件类型：C/C++ 或词法/语法源文件
- 规模：607 行
- 文件标识：`c407278a704a`
...
该文件实现 `streamlines` 的运行时工厂选择，根据类型名创建具体实现。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::functionObjects::streamlines::read` | 88 |
| `Foam::functionObjects::streamlines::fields` | 155 |
| `Foam::functionObjects::streamlines::execute` | 164 |
| `Foam::functionObjects::streamlines::write` | 170 |
| `Foam::functionObjects::streamlines::movePoints` | 560 |
| `Foam::functionObjects::streamlines::topoChange` | 569 |
| `Foam::functionObjects::streamlines::mapMesh` | 581 |
| `Foam::functionObjects::streamlines::distribute` | 593 |
...
- [`streamlines.H`](../../../14-postprocessing/files/f4/streamlines.h--f42fcacf0281.md)
