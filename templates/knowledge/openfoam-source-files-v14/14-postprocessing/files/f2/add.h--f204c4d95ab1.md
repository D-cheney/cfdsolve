...
slug: "openfoam-v14-file-f204c4d95ab1"
title: "OpenFOAM 14 源码解析：add.H"
summary: "该文件声明或实现 `add`，属于“功能对象与采样”模块。"
...
source_path: "src/functionObjects/field/add/add.H"
...
- 源码路径：`src/functionObjects/field/add/add.H`
- 功能分类：功能对象与采样
- 文件类型：C/C++ 或词法/语法源文件
- 规模：118 行
- 文件标识：`f204c4d95ab1`
