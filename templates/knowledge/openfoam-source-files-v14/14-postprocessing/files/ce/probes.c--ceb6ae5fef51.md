...
slug: "openfoam-v14-file-ceb6ae5fef51"
title: "OpenFOAM 14 源码解析：probes.C"
summary: "该文件实现 `probes` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/sampling/probes/probes.C"
tags: [OpenFOAM14, 源码解析, 功能对象与采样]
---

# OpenFOAM 14 源码解析：probes.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/sampling/probes/probes.C`
- 功能分类：功能对象与采样
- 文件类型：C/C++ 或词法/语法源文件
- 规模：518 行
- 文件标识：`ceb6ae5fef51`
...
该文件实现 `probes` 的运行时工厂选择，根据类型名创建具体实现。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::probes::findElements` | 58 |
| `Foam::probes::prepare` | 174 |
| `Foam::probes::read` | 301 |
| `Foam::probes::fields` | 336 |
| `Foam::probes::execute` | 342 |
| `Foam::probes::write` | 348 |
| `Foam::probes::movePoints` | 369 |
| `Foam::probes::topoChange` | 382 |
| `Foam::probes::mapMesh` | 462 |
| `Foam::probes::distribute` | 472 |
