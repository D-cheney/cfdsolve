...
slug: "openfoam-v14-file-e1a18a7fcc92"
...
source_path: "src/Lagrangian/cloud/clouds/particle/particle.C"
...
- 源码路径：`src/Lagrangian/cloud/clouds/particle/particle.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：285 行
- 文件标识：`e1a18a7fcc92`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::clouds::particle::dUdt` | 60 |
| `Foam::clouds::particle::reCalculateModified` | 74 |
| `Foam::clouds::particle::calculate` | 133 |
| `Foam::clouds::particle::partition` | 231 |
| `Foam::clouds::particle::solve` | 270 |
