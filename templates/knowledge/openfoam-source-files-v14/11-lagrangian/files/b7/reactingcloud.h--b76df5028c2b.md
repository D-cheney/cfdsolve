...
slug: "openfoam-v14-file-b76df5028c2b"
title: "OpenFOAM 14 源码解析：reactingCloud.H"
summary: "该文件为“拉格朗日与颗粒”提供 `reactingCloud` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/parcel/clouds/derived/reactingCloud/reactingCloud.H"
...
- 源码路径：`src/lagrangian/parcel/clouds/derived/reactingCloud/reactingCloud.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：74 行
- 文件标识：`b76df5028c2b`
...
该文件为“拉格朗日与颗粒”提供 `reactingCloud` 相关接口、模板实例或支撑定义。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Cloud class to introduce reacting parcels
...
- [`reactingParcel.H`](../../../11-lagrangian/files/83/reactingparcel.h--83dd882929c3.md)
...
- [src/lagrangian/parcel/clouds/derived/reactingCloud/reactingCloud.C](../../../11-lagrangian/files/c5/reactingcloud.c--c5435dbf91b2.md)
