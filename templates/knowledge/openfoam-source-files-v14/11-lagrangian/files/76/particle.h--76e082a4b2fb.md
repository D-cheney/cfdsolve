...
slug: "openfoam-v14-file-76e082a4b2fb"
title: "OpenFOAM 14 源码解析：particle.H"
summary: "该文件声明或实现 `particle`，属于“拉格朗日与颗粒”模块。"
...
source_path: "src/Lagrangian/cloud/clouds/particle/particle.H"
...
- 源码路径：`src/Lagrangian/cloud/clouds/particle/particle.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：132 行
- 文件标识：`76e082a4b2fb`
...
该文件声明或实现 `particle`，属于“拉格朗日与颗粒”模块。

中文导航角色：模块化拉格朗日颗粒框架。

上游说明：Cloud with spherical particles with thermodynamic modelling
