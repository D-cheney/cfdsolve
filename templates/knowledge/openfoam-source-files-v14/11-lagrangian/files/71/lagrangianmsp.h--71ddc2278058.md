...
slug: "openfoam-v14-file-71ddc2278058"
title: "OpenFOAM 14 源码解析：LagrangianmSp.H"
summary: "该文件声明或实现 `LagrangianEqn`、`PrimitiveField`，属于“拉格朗日与颗粒”模块。"
...
source_path: "src/Lagrangian/Lagrangian/Lagrangian/Lagrangianm/LagrangianmSp.H"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：LagrangianmSp.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/Lagrangian/Lagrangian/Lagrangian/Lagrangianm/LagrangianmSp.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：114 行
- 文件标识：`71ddc2278058`
...
该文件声明或实现 `LagrangianEqn`、`PrimitiveField`，属于“拉格朗日与颗粒”模块。

中文导航角色：模块化拉格朗日颗粒框架。

上游说明：Functions for calculating sources in a Lagrangian equation
...
- [`LagrangianmSp.C`](../../../11-lagrangian/files/0e/lagrangianmsp.c--0e8501be114b.md)
