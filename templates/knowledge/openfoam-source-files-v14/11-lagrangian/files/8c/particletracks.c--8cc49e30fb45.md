...
slug: "openfoam-v14-file-8cc49e30fb45"
title: "OpenFOAM 14 源码解析：ParticleTracks.C"
summary: "该文件为“拉格朗日与颗粒”提供 `ParticleTracks` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/parcel/submodels/CloudFunctionObjects/ParticleTracks/ParticleTracks.C"
...
- 源码路径：`src/lagrangian/parcel/submodels/CloudFunctionObjects/ParticleTracks/ParticleTracks.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：158 行
- 文件标识：`8cc49e30fb45`
...
该文件为“拉格朗日与颗粒”提供 `ParticleTracks` 相关接口、模板实例或支撑定义。
