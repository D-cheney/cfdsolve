...
slug: "openfoam-v14-file-f3ffbfec350a"
title: "OpenFOAM 14 源码解析：isotropic.H"
summary: "该文件声明或实现 `isotropic`，属于“拉格朗日与颗粒”模块。"
...
source_path: "src/lagrangian/parcel/submodels/MPPIC/TimeScaleModels/isotropic/isotropic.H"
...
- 源码路径：`src/lagrangian/parcel/submodels/MPPIC/TimeScaleModels/isotropic/isotropic.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：120 行
- 文件标识：`f3ffbfec350a`
