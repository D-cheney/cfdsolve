...
slug: "openfoam-v14-file-d35676d3516d"
title: "OpenFOAM 14 源码解析：sprayCloud.H"
summary: "该文件为“拉格朗日与颗粒”提供 `sprayCloud` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/parcel/clouds/derived/sprayCloud/sprayCloud.H"
...
- 源码路径：`src/lagrangian/parcel/clouds/derived/sprayCloud/sprayCloud.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：78 行
- 文件标识：`d35676d3516d`
...
该文件为“拉格朗日与颗粒”提供 `sprayCloud` 相关接口、模板实例或支撑定义。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Cloud class to introduce reacting spray parcels
...
- [`sprayParcel.H`](../../../11-lagrangian/files/12/sprayparcel.h--121225d57766.md)
...
- [src/lagrangian/parcel/clouds/derived/sprayCloud/sprayCloud.C](../../../11-lagrangian/files/c5/spraycloud.c--c54819ef9eb9.md)
