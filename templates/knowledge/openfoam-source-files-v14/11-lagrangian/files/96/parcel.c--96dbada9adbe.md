...
slug: "openfoam-v14-file-96dbada9adbe"
title: "OpenFOAM 14 源码解析：parcel.C"
...
source_path: "src/Lagrangian/cloud/clouds/parcel/parcel.C"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：parcel.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/Lagrangian/cloud/clouds/parcel/parcel.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：322 行
- 文件标识：`96dbada9adbe`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::clouds::parcel::dUdt` | 61 |
| `Foam::clouds::parcel::reCalculateModified` | 75 |
| `Foam::clouds::parcel::calculate` | 140 |
| `Foam::clouds::parcel::partition` | 267 |
| `Foam::clouds::parcel::solve` | 307 |
...
- [`parcel.H`](../../../11-lagrangian/files/1f/parcel.h--1fa2d1b63b22.md)
