...
slug: "openfoam-v14-file-a7f1eb7bc0b6"
title: "OpenFOAM 14 源码解析：makeThermoParcelSubmodels.C"
summary: "该文件为“拉格朗日与颗粒”提供 `makeThermoParcelSubmodels` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/parcel/parcels/derived/thermoParcel/makeThermoParcelSubmodels.C"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：makeThermoParcelSubmodels.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/lagrangian/parcel/parcels/derived/thermoParcel/makeThermoParcelSubmodels.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：67 行
- 文件标识：`a7f1eb7bc0b6`
...
该文件为“拉格朗日与颗粒”提供 `makeThermoParcelSubmodels` 相关接口、模板实例或支撑定义。
...
- [`thermoCloud.H`](../../../11-lagrangian/files/11/thermocloud.h--11f0b081792c.md)
...
- [`makeThermoParcelInjectionModels.H`](../../../11-lagrangian/files/49/makethermoparcelinjectionmodels.h--491e1f222577.md)
...
- [`NoComposition.H`](../../../11-lagrangian/files/b4/nocomposition.h--b4910d49e4b9.md)
- [`SinglePhaseMixture.H`](../../../11-lagrangian/files/96/singlephasemixture.h--96049240de2a.md)
