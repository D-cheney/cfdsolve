...
slug: "openfoam-v14-file-4f549d9d5a14"
...
source_path: "src/lagrangian/parcel/parcels/derived/reactingMultiphaseParcel/reactingMultiphaseParcel.H"
...
- 源码路径：`src/lagrangian/parcel/parcels/derived/reactingMultiphaseParcel/reactingMultiphaseParcel.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：82 行
- 文件标识：`4f549d9d5a14`
