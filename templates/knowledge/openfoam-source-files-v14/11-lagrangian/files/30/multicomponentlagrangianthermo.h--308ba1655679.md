...
slug: "openfoam-v14-file-308ba1655679"
title: "OpenFOAM 14 源码解析：multicomponentLagrangianThermo.H"
summary: "该文件声明或实现 `multicomponentLagrangianThermo`、`implementation`，属于“拉格朗日与颗粒”模块。"
...
该文件声明或实现 `multicomponentLagrangianThermo`、`implementation`，属于“拉格朗日与颗粒”模块。

中文导航角色：模块化拉格朗日颗粒框架。

上游说明：Base-class for multicomponent Lagrangian thermodynamic models

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `multicomponentLagrangianThermo` | 58 |
| `implementation` | 83 |
...
- [`MulticomponentLagrangianThermo.H`](../../../11-lagrangian/files/a3/multicomponentlagrangianthermo.h--a3f675c8fd29.md)
...
- [`multicomponentLagrangianThermoI.H`](../../../11-lagrangian/files/93/multicomponentlagrangianthermoi.h--93e30af4c4b0.md)
...
- [src/Lagrangian/LagrangianThermo/multicomponentLagrangianThermo/multicomponentLagrangianThermoI.H](../../../11-lagrangian/files/93/multicomponentlagrangianthermoi.h--93e30af4c4b0.md)
