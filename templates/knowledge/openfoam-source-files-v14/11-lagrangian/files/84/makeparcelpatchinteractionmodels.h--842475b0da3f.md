...
slug: "openfoam-v14-file-842475b0da3f"
title: "OpenFOAM 14 源码解析：makeParcelPatchInteractionModels.H"
summary: "该文件为“拉格朗日与颗粒”提供 `makeParcelPatchInteractionModels` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/parcel/parcels/include/makeParcelPatchInteractionModels.H"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：makeParcelPatchInteractionModels.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/lagrangian/parcel/parcels/include/makeParcelPatchInteractionModels.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：58 行
- 文件标识：`842475b0da3f`
...
该文件为“拉格朗日与颗粒”提供 `makeParcelPatchInteractionModels` 相关接口、模板实例或支撑定义。
...
- [`LocalInteraction.H`](../../../11-lagrangian/files/c8/localinteraction.h--c82844045dce.md)
- [`NoInteraction.H`](../../../11-lagrangian/files/d4/nointeraction.h--d4f604563439.md)
- [`Rebound.H`](../../../11-lagrangian/files/5b/rebound.h--5bd834d5710d.md)
- [`StandardWallInteraction.H`](../../../11-lagrangian/files/07/standardwallinteraction.h--076c3498fc43.md)
