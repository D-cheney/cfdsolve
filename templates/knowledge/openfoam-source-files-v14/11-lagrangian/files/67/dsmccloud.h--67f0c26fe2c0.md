...
slug: "openfoam-v14-file-67f0c26fe2c0"
title: "OpenFOAM 14 源码解析：dsmcCloud.H"
summary: "该文件为“拉格朗日与颗粒”提供 `dsmcCloud` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/DSMC/clouds/derived/dsmcCloud/dsmcCloud.H"
...
- 源码路径：`src/lagrangian/DSMC/clouds/derived/dsmcCloud/dsmcCloud.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：58 行
- 文件标识：`67f0c26fe2c0`
...
该文件为“拉格朗日与颗粒”提供 `dsmcCloud` 相关接口、模板实例或支撑定义。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Cloud class to simulate dsmc parcels
