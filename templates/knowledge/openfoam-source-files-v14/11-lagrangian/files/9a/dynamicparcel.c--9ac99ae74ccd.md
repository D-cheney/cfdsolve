...
slug: "openfoam-v14-file-9ac99ae74ccd"
title: "OpenFOAM 14 源码解析：dynamicParcel.C"
...
source_path: "src/Lagrangian/cloud/clouds/dynamicParcel/dynamicParcel.C"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：dynamicParcel.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/Lagrangian/cloud/clouds/dynamicParcel/dynamicParcel.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：266 行
- 文件标识：`9ac99ae74ccd`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::clouds::dynamicParcel::dUdt` | 61 |
| `Foam::clouds::dynamicParcel::reCalculateModified` | 75 |
| `Foam::clouds::dynamicParcel::calculate` | 123 |
| `Foam::clouds::dynamicParcel::partition` | 213 |
| `Foam::clouds::dynamicParcel::solve` | 251 |
...
- [`dynamicParcel.H`](../../../11-lagrangian/files/86/dynamicparcel.h--8612ac07a1b1.md)
