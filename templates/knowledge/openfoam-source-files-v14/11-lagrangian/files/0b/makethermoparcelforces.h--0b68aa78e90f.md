...
slug: "openfoam-v14-file-0b68aa78e90f"
title: "OpenFOAM 14 源码解析：makeThermoParcelForces.H"
summary: "该文件为“拉格朗日与颗粒”提供 `makeThermoParcelForces` 相关接口、模板实例或支撑定义。"
...
source_path: "src/lagrangian/parcel/parcels/include/makeThermoParcelForces.H"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：makeThermoParcelForces.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/lagrangian/parcel/parcels/include/makeThermoParcelForces.H`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：54 行
- 文件标识：`0b68aa78e90f`
...
该文件为“拉格朗日与颗粒”提供 `makeThermoParcelForces` 相关接口、模板实例或支撑定义。
...
- [`BrownianMotionForce.H`](../../../11-lagrangian/files/50/brownianmotionforce.h--50da399f72dc.md)
