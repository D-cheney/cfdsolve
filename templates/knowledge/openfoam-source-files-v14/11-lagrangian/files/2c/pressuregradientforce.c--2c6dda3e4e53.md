...
slug: "openfoam-v14-file-2c6dda3e4e53"
title: "OpenFOAM 14 源码解析：PressureGradientForce.C"
summary: "该文件实现 `PressureGradientForce` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/lagrangian/parcel/submodels/Momentum/ParticleForces/PressureGradient/PressureGradientForce.C"
...
- 源码路径：`src/lagrangian/parcel/submodels/Momentum/ParticleForces/PressureGradient/PressureGradientForce.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：162 行
- 文件标识：`2c6dda3e4e53`
...
该文件实现 `PressureGradientForce` 的运行时工厂选择，根据类型名创建具体实现。
