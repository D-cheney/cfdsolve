...
slug: "openfoam-v14-file-cd3ea514b3a6"
title: "OpenFOAM 14 源码解析：DSMCParcel.C"
...
source_path: "src/lagrangian/DSMC/parcels/Templates/DSMCParcel/DSMCParcel.C"
tags: [OpenFOAM14, 源码解析, 拉格朗日与颗粒]
---

# OpenFOAM 14 源码解析：DSMCParcel.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/lagrangian/DSMC/parcels/Templates/DSMCParcel/DSMCParcel.C`
- 功能分类：拉格朗日与颗粒
- 文件类型：C/C++ 或词法/语法源文件
- 规模：188 行
- 文件标识：`cd3ea514b3a6`
...
- [`DSMCParcelIO.C`](../../../11-lagrangian/files/bc/dsmcparcelio.c--bc4749315404.md)
