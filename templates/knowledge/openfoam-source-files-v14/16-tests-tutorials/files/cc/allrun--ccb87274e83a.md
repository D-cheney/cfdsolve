...
slug: "openfoam-v14-file-ccb87274e83a"
...
source_path: "tutorials/multiphaseEuler/wallCondensation/Allrun"
...
- 源码路径：`tutorials/multiphaseEuler/wallCondensation/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`ccb87274e83a`
