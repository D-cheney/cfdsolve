...
slug: "openfoam-v14-file-cc61c9b0b528"
...
source_path: "tutorials/fluid/angledDuctExplicitFixedCoeff/Allrun"
...
- 源码路径：`tutorials/fluid/angledDuctExplicitFixedCoeff/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`cc61c9b0b528`
