...
slug: "openfoam-v14-file-19290e17e10d"
...
source_path: "tutorials/multiphaseEuler/wallBoilingPolydisperse/Allrun"
...
- 源码路径：`tutorials/multiphaseEuler/wallBoilingPolydisperse/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：44 行
- 文件标识：`19290e17e10d`
