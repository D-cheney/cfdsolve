...
slug: "openfoam-v14-file-9deb6aece3d0"
...
source_path: "tutorials/multiphaseEuler/mixerVessel2DMRF/Allrun"
...
- 源码路径：`tutorials/multiphaseEuler/mixerVessel2DMRF/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`9deb6aece3d0`
