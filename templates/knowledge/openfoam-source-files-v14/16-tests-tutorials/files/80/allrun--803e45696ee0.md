...
slug: "openfoam-v14-file-803e45696ee0"
...
source_path: "tutorials/incompressibleVoF/damBreakTracer/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/damBreakTracer/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`803e45696ee0`
