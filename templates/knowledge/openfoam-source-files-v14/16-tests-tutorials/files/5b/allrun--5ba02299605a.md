...
slug: "openfoam-v14-file-5ba02299605a"
...
source_path: "tutorials/incompressibleFluid/pitzDailyLES/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/pitzDailyLES/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`5ba02299605a`
