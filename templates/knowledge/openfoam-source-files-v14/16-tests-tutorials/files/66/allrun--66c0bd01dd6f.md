...
slug: "openfoam-v14-file-66c0bd01dd6f"
...
source_path: "tutorials/incompressibleFluid/waveSubSurface/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/waveSubSurface/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：19 行
- 文件标识：`66c0bd01dd6f`
