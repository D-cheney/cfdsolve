...
slug: "openfoam-v14-file-0393cf993e2e"
...
source_path: "tutorials/incompressibleFluid/porousBlockage/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/porousBlockage/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：16 行
- 文件标识：`0393cf993e2e`
