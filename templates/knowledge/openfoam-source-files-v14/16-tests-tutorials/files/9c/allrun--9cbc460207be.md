...
slug: "openfoam-v14-file-9cbc460207be"
...
source_path: "tutorials/incompressibleFluid/pitzDailyLTS/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/pitzDailyLTS/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`9cbc460207be`
