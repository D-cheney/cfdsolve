...
slug: "openfoam-v14-file-9e8a232ccdaf"
...
source_path: "tutorials/multicomponentFluid/verticalChannelSteady/Allrun"
...
- 源码路径：`tutorials/multicomponentFluid/verticalChannelSteady/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：23 行
- 文件标识：`9e8a232ccdaf`
