...
slug: "openfoam-v14-file-9524aaa4bd9f"
...
source_path: "tutorials/legacy/compressible/rhoPorousSimpleFoam/angledDuctImplicit/Allrun"
...
- 源码路径：`tutorials/legacy/compressible/rhoPorousSimpleFoam/angledDuctImplicit/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`9524aaa4bd9f`
