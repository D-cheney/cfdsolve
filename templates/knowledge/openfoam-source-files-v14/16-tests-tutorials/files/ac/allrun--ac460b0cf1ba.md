...
slug: "openfoam-v14-file-ac460b0cf1ba"
...
source_path: "tutorials/incompressibleVoF/floatingObjectWaves/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/floatingObjectWaves/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`ac460b0cf1ba`
