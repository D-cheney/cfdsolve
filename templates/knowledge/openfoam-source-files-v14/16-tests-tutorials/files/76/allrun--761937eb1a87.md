...
slug: "openfoam-v14-file-761937eb1a87"
...
source_path: "tutorials/incompressibleFluid/mixerVessel2DMRF/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/mixerVessel2DMRF/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`761937eb1a87`
