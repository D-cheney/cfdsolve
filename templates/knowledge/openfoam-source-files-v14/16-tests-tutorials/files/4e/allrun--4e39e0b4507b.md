...
slug: "openfoam-v14-file-4e39e0b4507b"
...
source_path: "tutorials/legacy/lagrangian/dsmcFoam/freeSpaceStream/Allrun"
...
- 源码路径：`tutorials/legacy/lagrangian/dsmcFoam/freeSpaceStream/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：16 行
- 文件标识：`4e39e0b4507b`
