...
slug: "openfoam-v14-file-baf36ac9483d"
...
source_path: "tutorials/compressibleVoF/damBreakInjection/Allrun"
...
- 源码路径：`tutorials/compressibleVoF/damBreakInjection/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`baf36ac9483d`
