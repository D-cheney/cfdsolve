...
slug: "openfoam-v14-file-6b388e15b4db"
...
source_path: "tutorials/incompressibleFluid/pitzDailyPulse/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/pitzDailyPulse/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`6b388e15b4db`
