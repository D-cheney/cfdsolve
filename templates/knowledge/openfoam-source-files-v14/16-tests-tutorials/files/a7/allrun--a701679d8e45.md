...
slug: "openfoam-v14-file-a701679d8e45"
...
source_path: "tutorials/incompressibleDenseParticleFluid/injectionChannel/Allrun"
...
- 源码路径：`tutorials/incompressibleDenseParticleFluid/injectionChannel/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`a701679d8e45`
