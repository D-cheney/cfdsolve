...
slug: "openfoam-v14-file-a7ff6edba63f"
...
source_path: "tutorials/incompressibleFluid/simpleRushtonMRF/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/simpleRushtonMRF/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：86 行
- 文件标识：`a7ff6edba63f`
