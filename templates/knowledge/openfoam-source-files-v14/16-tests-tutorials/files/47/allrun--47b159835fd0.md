...
slug: "openfoam-v14-file-47b159835fd0"
...
source_path: "tutorials/incompressibleFluid/roomResidenceTime/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/roomResidenceTime/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：23 行
- 文件标识：`47b159835fd0`
