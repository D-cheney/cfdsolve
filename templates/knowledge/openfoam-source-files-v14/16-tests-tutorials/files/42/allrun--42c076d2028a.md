...
slug: "openfoam-v14-file-42c076d2028a"
...
source_path: "tutorials/incompressibleFluid/motorBikeSteady/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/motorBikeSteady/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：27 行
- 文件标识：`42c076d2028a`
