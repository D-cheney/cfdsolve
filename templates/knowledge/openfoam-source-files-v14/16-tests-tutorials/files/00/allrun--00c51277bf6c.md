...
slug: "openfoam-v14-file-00c51277bf6c"
...
source_path: "tutorials/incompressibleVoF/sloshingTank3D6DoF/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/sloshingTank3D6DoF/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`00c51277bf6c`
