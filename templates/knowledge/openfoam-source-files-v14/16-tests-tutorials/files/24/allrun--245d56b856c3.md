...
slug: "openfoam-v14-file-245d56b856c3"
...
source_path: "tutorials/incompressibleFluid/flowWithOpenBoundary/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/flowWithOpenBoundary/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：117 行
- 文件标识：`245d56b856c3`
