...
slug: "openfoam-v14-file-48c4687879d4"
...
source_path: "tutorials/multicomponentFluid/smallPoolFire3D/Allrun"
...
- 源码路径：`tutorials/multicomponentFluid/smallPoolFire3D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`48c4687879d4`
