...
slug: "openfoam-v14-file-550d07083749"
...
source_path: "tutorials/incompressibleFluid/simpleRushtonNCC/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/simpleRushtonNCC/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：107 行
- 文件标识：`550d07083749`
