...
slug: "openfoam-v14-file-695af467b0bf"
...
source_path: "test/multiphaseEuler/populationBalance/binaryBreakup/Allrun"
...
- 源码路径：`test/multiphaseEuler/populationBalance/binaryBreakup/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：17 行
- 文件标识：`695af467b0bf`
