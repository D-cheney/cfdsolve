...
slug: "openfoam-v14-file-e9b93156241d"
...
source_path: "tutorials/incompressibleVoF/cavitatingBullet/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/cavitatingBullet/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：24 行
- 文件标识：`e9b93156241d`
