...
slug: "openfoam-v14-file-e92a3584193d"
...
source_path: "tutorials/multicomponentFluid/verticalChannel/Allrun"
...
- 源码路径：`tutorials/multicomponentFluid/verticalChannel/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：26 行
- 文件标识：`e92a3584193d`
