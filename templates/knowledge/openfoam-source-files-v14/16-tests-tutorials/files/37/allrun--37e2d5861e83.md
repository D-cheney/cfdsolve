...
slug: "openfoam-v14-file-37e2d5861e83"
...
source_path: "test/boundaryLayer/boundaryWallFunctionsProfile/Allrun"
...
- 源码路径：`test/boundaryLayer/boundaryWallFunctionsProfile/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：78 行
- 文件标识：`37e2d5861e83`
