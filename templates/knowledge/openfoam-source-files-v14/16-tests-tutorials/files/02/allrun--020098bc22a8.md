...
slug: "openfoam-v14-file-020098bc22a8"
...
source_path: "tutorials/legacy/incompressible/icoFoam/elbow/Allrun"
...
- 源码路径：`tutorials/legacy/incompressible/icoFoam/elbow/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：17 行
- 文件标识：`020098bc22a8`
