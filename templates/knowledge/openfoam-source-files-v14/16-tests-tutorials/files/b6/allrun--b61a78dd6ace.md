...
slug: "openfoam-v14-file-b61a78dd6ace"
...
source_path: "tutorials/incompressibleMultiphaseVoF/damBreak4phaseFineLaminar/Allrun"
...
- 源码路径：`tutorials/incompressibleMultiphaseVoF/damBreak4phaseFineLaminar/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：17 行
- 文件标识：`b61a78dd6ace`
