...
slug: "openfoam-v14-file-f4c539803bca"
...
source_path: "tutorials/incompressibleFluid/planarPoiseuille/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/planarPoiseuille/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`f4c539803bca`
