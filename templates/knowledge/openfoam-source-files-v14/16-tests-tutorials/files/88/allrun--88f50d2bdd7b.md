...
slug: "openfoam-v14-file-88f50d2bdd7b"
...
source_path: "tutorials/legacy/incompressible/adjointShapeOptimisationFoam/pitzDaily/Allrun"
...
- 源码路径：`tutorials/legacy/incompressible/adjointShapeOptimisationFoam/pitzDaily/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`88f50d2bdd7b`
