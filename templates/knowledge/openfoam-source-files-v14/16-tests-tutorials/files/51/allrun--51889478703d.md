...
slug: "openfoam-v14-file-51889478703d"
...
source_path: "test/multiphaseEuler/populationBalance/coalescence/Allrun"
...
- 源码路径：`test/multiphaseEuler/populationBalance/coalescence/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`51889478703d`
