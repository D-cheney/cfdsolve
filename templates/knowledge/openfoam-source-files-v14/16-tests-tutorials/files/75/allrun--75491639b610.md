...
slug: "openfoam-v14-file-75491639b610"
...
source_path: "tutorials/multicomponentFluid/smallPoolFire2D/Allrun"
...
- 源码路径：`tutorials/multicomponentFluid/smallPoolFire2D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：16 行
- 文件标识：`75491639b610`
