...
slug: "openfoam-v14-file-5d207580ab28"
...
source_path: "tutorials/incompressibleDriftFlux/mixerVessel2DMRF/Allrun"
...
- 源码路径：`tutorials/incompressibleDriftFlux/mixerVessel2DMRF/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`5d207580ab28`
