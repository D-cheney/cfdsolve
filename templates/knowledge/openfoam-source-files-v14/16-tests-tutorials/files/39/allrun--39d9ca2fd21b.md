...
slug: "openfoam-v14-file-39d9ca2fd21b"
...
source_path: "test/multiphaseEuler/populationBalance/breakup/Allrun"
...
- 源码路径：`test/multiphaseEuler/populationBalance/breakup/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：17 行
- 文件标识：`39d9ca2fd21b`
