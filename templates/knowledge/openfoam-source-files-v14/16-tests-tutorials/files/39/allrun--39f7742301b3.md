...
slug: "openfoam-v14-file-39f7742301b3"
...
source_path: "tutorials/legacy/basic/financialFoam/europeanCall/Allrun"
...
- 源码路径：`tutorials/legacy/basic/financialFoam/europeanCall/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`39f7742301b3`
