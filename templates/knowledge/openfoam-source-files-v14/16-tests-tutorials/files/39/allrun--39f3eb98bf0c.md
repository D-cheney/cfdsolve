...
slug: "openfoam-v14-file-39f3eb98bf0c"
...
source_path: "tutorials/multiRegion/film/cylinderDripping/Allrun"
...
- 源码路径：`tutorials/multiRegion/film/cylinderDripping/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`39f3eb98bf0c`
