...
slug: "openfoam-v14-file-0477958376cc"
...
source_path: "tutorials/legacy/lagrangian/mdFoam/nanoNozzle/Allrun"
...
- 源码路径：`tutorials/legacy/lagrangian/mdFoam/nanoNozzle/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：21 行
- 文件标识：`0477958376cc`
