...
slug: "openfoam-v14-file-741cdf07b868"
...
source_path: "tutorials/incompressibleFluid/drivaerFastback/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/drivaerFastback/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：122 行
- 文件标识：`741cdf07b868`
