...
slug: "openfoam-v14-file-567f2d06ea21"
...
source_path: "tutorials/incompressibleVoF/damBreakLaminarFine/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/damBreakLaminarFine/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：22 行
- 文件标识：`567f2d06ea21`
