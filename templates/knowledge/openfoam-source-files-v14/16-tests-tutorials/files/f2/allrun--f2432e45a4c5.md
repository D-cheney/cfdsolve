...
slug: "openfoam-v14-file-f2432e45a4c5"
...
source_path: "tutorials/legacy/basic/laplacianFoam/flange/Allrun"
...
- 源码路径：`tutorials/legacy/basic/laplacianFoam/flange/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：29 行
- 文件标识：`f2432e45a4c5`
