...
slug: "openfoam-v14-file-cefe3b44d0f0"
...
source_path: "tutorials/multiRegion/CHT/multiphaseCoolingCylinder2D/Allrun"
...
- 源码路径：`tutorials/multiRegion/CHT/multiphaseCoolingCylinder2D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`cefe3b44d0f0`
