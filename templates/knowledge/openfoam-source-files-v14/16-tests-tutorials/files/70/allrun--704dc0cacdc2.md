...
slug: "openfoam-v14-file-704dc0cacdc2"
...
source_path: "tutorials/incompressibleVoF/damBreakPorousBaffle/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/damBreakPorousBaffle/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：21 行
- 文件标识：`704dc0cacdc2`
