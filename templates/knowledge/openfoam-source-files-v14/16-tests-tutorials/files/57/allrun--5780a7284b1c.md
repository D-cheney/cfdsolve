...
slug: "openfoam-v14-file-5780a7284b1c"
...
source_path: "tutorials/multicomponentFluid/verticalChannelLTS/Allrun"
...
- 源码路径：`tutorials/multicomponentFluid/verticalChannelLTS/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：26 行
- 文件标识：`5780a7284b1c`
