...
slug: "openfoam-v14-file-de8e20273d55"
...
source_path: "tutorials/incompressibleVoF/damBreakInjection/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/damBreakInjection/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`de8e20273d55`
