...
slug: "openfoam-v14-file-9967a6d31c35"
...
source_path: "tutorials/incompressibleFluid/motorBike/motorBike/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/motorBike/motorBike/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：27 行
- 文件标识：`9967a6d31c35`
