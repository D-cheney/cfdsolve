...
slug: "openfoam-v14-file-adc150c2bf3d"
...
source_path: "tutorials/incompressibleVoF/sloshingTank2D3DoF/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/sloshingTank2D3DoF/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`adc150c2bf3d`
