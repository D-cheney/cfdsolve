...
slug: "openfoam-v14-file-ad7b7f5f706d"
...
source_path: "tutorials/multiRegion/CHT/shellAndTubeHeatExchanger/Allrun"
...
- 源码路径：`tutorials/multiRegion/CHT/shellAndTubeHeatExchanger/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`ad7b7f5f706d`
