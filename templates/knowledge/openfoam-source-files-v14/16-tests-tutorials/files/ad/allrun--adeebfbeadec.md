...
slug: "openfoam-v14-file-adeebfbeadec"
...
source_path: "tutorials/incompressibleVoF/floatingObject/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/floatingObject/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：17 行
- 文件标识：`adeebfbeadec`
