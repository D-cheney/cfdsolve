...
slug: "openfoam-v14-file-1bea7797a87d"
...
source_path: "tutorials/mesh/blockMesh/sphere7ProjectedEdges/Allrun"
...
- 源码路径：`tutorials/mesh/blockMesh/sphere7ProjectedEdges/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：14 行
- 文件标识：`1bea7797a87d`
