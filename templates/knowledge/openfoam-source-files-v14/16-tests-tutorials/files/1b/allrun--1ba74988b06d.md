...
slug: "openfoam-v14-file-1ba74988b06d"
...
source_path: "tutorials/legacy/lagrangian/dsmcFoam/supersonicCorner/Allrun"
...
- 源码路径：`tutorials/legacy/lagrangian/dsmcFoam/supersonicCorner/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`1ba74988b06d`
