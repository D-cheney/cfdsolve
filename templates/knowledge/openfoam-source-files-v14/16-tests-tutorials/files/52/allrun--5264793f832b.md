...
slug: "openfoam-v14-file-5264793f832b"
...
source_path: "tutorials/legacy/lagrangian/dsmcFoam/wedge15Ma5/Allrun"
...
- 源码路径：`tutorials/legacy/lagrangian/dsmcFoam/wedge15Ma5/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：19 行
- 文件标识：`5264793f832b`
