...
slug: "openfoam-v14-file-d748551e5060"
...
source_path: "tutorials/incompressibleFluid/hopperParticles/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/hopperParticles/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：29 行
- 文件标识：`d748551e5060`
