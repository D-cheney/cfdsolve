...
slug: "openfoam-v14-file-d7fb0e58e917"
...
source_path: "tutorials/multiRegion/CHT/VoFcoolingCylinder2D/Allrun"
...
- 源码路径：`tutorials/multiRegion/CHT/VoFcoolingCylinder2D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`d7fb0e58e917`
