...
slug: "openfoam-v14-file-0525a89e2d73"
...
source_path: "tutorials/multiRegion/CHT/circuitBoardCooling/Allrun"
...
- 源码路径：`tutorials/multiRegion/CHT/circuitBoardCooling/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：35 行
- 文件标识：`0525a89e2d73`
