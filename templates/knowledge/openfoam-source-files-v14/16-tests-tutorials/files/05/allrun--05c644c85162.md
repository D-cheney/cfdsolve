...
slug: "openfoam-v14-file-05c644c85162"
...
source_path: "tutorials/legacy/incompressible/icoFoam/cavity/Allrun"
...
- 源码路径：`tutorials/legacy/incompressible/icoFoam/cavity/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：95 行
- 文件标识：`05c644c85162`
