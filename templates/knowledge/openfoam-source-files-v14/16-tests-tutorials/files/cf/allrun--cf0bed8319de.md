...
slug: "openfoam-v14-file-cf0bed8319de"
...
source_path: "tutorials/isothermalFluid/potentialFreeSurfaceMovingOscillatingBox/Allrun"
...
- 源码路径：`tutorials/isothermalFluid/potentialFreeSurfaceMovingOscillatingBox/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`cf0bed8319de`
