...
slug: "openfoam-v14-file-b9b548980058"
...
source_path: "tutorials/incompressibleDenseParticleFluid/cyclone/Allrun"
...
- 源码路径：`tutorials/incompressibleDenseParticleFluid/cyclone/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：20 行
- 文件标识：`b9b548980058`
