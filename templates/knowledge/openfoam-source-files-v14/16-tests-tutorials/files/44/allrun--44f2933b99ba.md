...
slug: "openfoam-v14-file-44f2933b99ba"
...
source_path: "tutorials/incompressibleFluid/oscillatingInlet/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/oscillatingInlet/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`44f2933b99ba`
