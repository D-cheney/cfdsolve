...
slug: "openfoam-v14-file-461817369b8c"
...
source_path: "tutorials/multiphaseEuler/titaniaSynthesis/Allrun"
...
- 源码路径：`tutorials/multiphaseEuler/titaniaSynthesis/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：19 行
- 文件标识：`461817369b8c`
