...
slug: "openfoam-v14-file-2be1376b68fe"
...
source_path: "tutorials/incompressibleVoF/forcedUpstreamWave/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/forcedUpstreamWave/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：24 行
- 文件标识：`2be1376b68fe`
