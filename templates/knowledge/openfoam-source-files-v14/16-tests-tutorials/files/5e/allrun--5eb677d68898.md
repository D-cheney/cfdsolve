...
slug: "openfoam-v14-file-5eb677d68898"
...
source_path: "test/multiphaseEuler/populationBalance/expansion/Allrun"
...
- 源码路径：`test/multiphaseEuler/populationBalance/expansion/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：18 行
- 文件标识：`5eb677d68898`
