...
slug: "openfoam-v14-file-dae7817782fe"
...
source_path: "tutorials/multiphaseEuler/titaniaSynthesisSurface/Allrun"
...
- 源码路径：`tutorials/multiphaseEuler/titaniaSynthesisSurface/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：19 行
- 文件标识：`dae7817782fe`
