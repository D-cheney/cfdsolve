...
slug: "openfoam-v14-file-da3773fb7f52"
...
source_path: "tutorials/incompressibleVoF/sloshingCylinder/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/sloshingCylinder/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：16 行
- 文件标识：`da3773fb7f52`
