...
slug: "openfoam-v14-file-6de2f432021f"
...
source_path: "tutorials/incompressibleFluid/TJunctionFan/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/TJunctionFan/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：22 行
- 文件标识：`6de2f432021f`
