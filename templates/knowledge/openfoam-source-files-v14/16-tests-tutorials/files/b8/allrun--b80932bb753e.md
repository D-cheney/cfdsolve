...
slug: "openfoam-v14-file-b80932bb753e"
...
source_path: "tutorials/incompressibleFluid/windAroundBuildings/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/windAroundBuildings/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：19 行
- 文件标识：`b80932bb753e`
