...
slug: "openfoam-v14-file-b83ea82d9487"
...
source_path: "tutorials/legacy/electromagnetics/mhdFoam/hartmann/Allrun"
...
- 源码路径：`tutorials/legacy/electromagnetics/mhdFoam/hartmann/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：16 行
- 文件标识：`b83ea82d9487`
