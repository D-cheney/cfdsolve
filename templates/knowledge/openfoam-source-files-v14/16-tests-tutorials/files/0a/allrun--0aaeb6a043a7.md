...
slug: "openfoam-v14-file-0aaeb6a043a7"
...
source_path: "tutorials/incompressibleFluid/turbineSiting/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/turbineSiting/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：21 行
- 文件标识：`0aaeb6a043a7`
