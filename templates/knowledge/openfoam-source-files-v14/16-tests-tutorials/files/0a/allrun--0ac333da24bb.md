...
slug: "openfoam-v14-file-0ac333da24bb"
...
source_path: "tutorials/incompressibleVoF/mixerVesselHorizontal2D/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/mixerVesselHorizontal2D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：19 行
- 文件标识：`0ac333da24bb`
