...
slug: "openfoam-v14-file-f92fbbb8c7b2"
...
source_path: "tutorials/incompressibleVoF/sloshingTank3D/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/sloshingTank3D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`f92fbbb8c7b2`
