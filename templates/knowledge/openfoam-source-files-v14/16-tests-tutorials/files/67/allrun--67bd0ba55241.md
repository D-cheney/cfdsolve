...
slug: "openfoam-v14-file-67bd0ba55241"
...
source_path: "tutorials/incompressibleVoF/sloshingTank2D/Allrun"
...
- 源码路径：`tutorials/incompressibleVoF/sloshingTank2D/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：16 行
- 文件标识：`67bd0ba55241`
