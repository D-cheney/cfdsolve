...
slug: "openfoam-v14-file-f7488180b511"
...
source_path: "tutorials/incompressibleFluid/pitzDailySteady/Allrun"
...
- 源码路径：`tutorials/incompressibleFluid/pitzDailySteady/Allrun`
- 功能分类：测试与教程脚本
- 文件类型：脚本
- 规模：15 行
- 文件标识：`f7488180b511`
