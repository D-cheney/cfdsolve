...
slug: "openfoam-v14-file-5d2ccb36a9dd"
...
上游说明：Templated unburnt gas mixture for homogeneous lean, stoichiometric or rich conditions

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `UHomogeneousMixture` | 58 |
...
- [`UHomogeneousMixture.C`](../../../02-solver-modules/files/a0/uhomogeneousmixture.c--a0fb47d9195f.md)

## 8. 直接上层引用

- [applications/modules/XiFluid/uRhoMulticomponentThermo/mixtures/uHomogeneousMixture/UHomogeneousMixture.C](../../../02-solver-modules/files/a0/uhomogeneousmixture.c--a0fb47d9195f.md)
