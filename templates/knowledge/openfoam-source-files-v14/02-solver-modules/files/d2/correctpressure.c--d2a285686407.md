...
slug: "openfoam-v14-file-d2a285686407"
...
source_path: "applications/modules/incompressibleDenseParticleFluid/correctPressure.C"
...
- 源码路径：`applications/modules/incompressibleDenseParticleFluid/correctPressure.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：145 行
- 文件标识：`d2a285686407`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::incompressibleDenseParticleFluid::correctPressure` | 44 |
