...
slug: "openfoam-v14-file-b598e15fafc6"
...
source_path: "applications/modules/incompressibleFluid/momentumPredictor.C"
...
- 源码路径：`applications/modules/incompressibleFluid/momentumPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：65 行
- 文件标识：`b598e15fafc6`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::incompressibleFluid::momentumPredictor` | 37 |
