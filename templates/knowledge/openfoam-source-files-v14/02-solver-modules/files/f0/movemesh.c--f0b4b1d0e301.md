...
slug: "openfoam-v14-file-f0b4b1d0e301"
...
source_path: "applications/modules/incompressibleDenseParticleFluid/moveMesh.C"
...
- 源码路径：`applications/modules/incompressibleDenseParticleFluid/moveMesh.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：84 行
- 文件标识：`f0b4b1d0e301`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::incompressibleDenseParticleFluid::moveMesh` | 38 |
| `Foam::solvers::incompressibleDenseParticleFluid::motionCorrector` | 47 |
