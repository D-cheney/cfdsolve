...
slug: "openfoam-v14-file-7444d8bb692b"
title: "OpenFOAM 14 源码解析：SolidThermalPhaseModel.C"
summary: "该文件实现 `SolidThermalPhaseModel` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "applications/modules/multiphaseEuler/phaseSystem/phaseModels/SolidThermalPhaseModel/SolidThermalPhaseModel.C"
tags: [OpenFOAM14, 源码解析, 模块化求解器]
---

# OpenFOAM 14 源码解析：SolidThermalPhaseModel.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/modules/multiphaseEuler/phaseSystem/phaseModels/SolidThermalPhaseModel/SolidThermalPhaseModel.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：136 行
- 文件标识：`7444d8bb692b`
...
该文件实现 `SolidThermalPhaseModel` 的运行时工厂选择，根据类型名创建具体实现。
