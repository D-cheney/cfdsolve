...
slug: "openfoam-v14-file-d5cab762b959"
...
source_path: "applications/modules/incompressibleDenseParticleFluid/momentumPredictor.C"
...
- 源码路径：`applications/modules/incompressibleDenseParticleFluid/momentumPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：82 行
- 文件标识：`d5cab762b959`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::incompressibleDenseParticleFluid::momentumPredictor` | 40 |
