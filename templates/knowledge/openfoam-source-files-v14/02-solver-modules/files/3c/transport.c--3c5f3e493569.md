...
slug: "openfoam-v14-file-3c5f3e493569"
...
source_path: "applications/modules/XiFluid/XiModels/transport/transport.C"
...
- 源码路径：`applications/modules/XiFluid/XiModels/transport/transport.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：198 行
- 文件标识：`3c5f3e493569`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::XiModels::transport::readCoeffs` | 55 |
| `Foam::XiModels::transport::Db` | 96 |
| `Foam::XiModels::transport::correct` | 101 |
