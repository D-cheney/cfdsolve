...
slug: "openfoam-v14-file-591c20ed3691"
...
source_path: "applications/modules/compressibleVoF/thermophysicalPredictor.C"
...
- 源码路径：`applications/modules/compressibleVoF/thermophysicalPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：112 行
- 文件标识：`591c20ed3691`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::compressibleVoF::thermophysicalPredictor` | 40 |
