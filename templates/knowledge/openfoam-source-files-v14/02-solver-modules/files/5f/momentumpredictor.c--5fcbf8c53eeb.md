...
slug: "openfoam-v14-file-5fcbf8c53eeb"
...
source_path: "applications/modules/isothermalFluid/momentumPredictor.C"
...
- 源码路径：`applications/modules/isothermalFluid/momentumPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：78 行
- 文件标识：`5fcbf8c53eeb`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::isothermalFluid::momentumPredictor` | 37 |
