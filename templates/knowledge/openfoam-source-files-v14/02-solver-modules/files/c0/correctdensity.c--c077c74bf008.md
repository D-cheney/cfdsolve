...
slug: "openfoam-v14-file-c077c74bf008"
...
source_path: "applications/modules/shockFluid/correctDensity.C"
...
- 源码路径：`applications/modules/shockFluid/correctDensity.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：57 行
- 文件标识：`c077c74bf008`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::shockFluid::correctDensity` | 37 |
