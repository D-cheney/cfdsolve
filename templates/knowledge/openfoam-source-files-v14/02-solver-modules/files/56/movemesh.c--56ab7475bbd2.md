...
slug: "openfoam-v14-file-56ab7475bbd2"
...
source_path: "applications/modules/shockFluid/moveMesh.C"
...
- 源码路径：`applications/modules/shockFluid/moveMesh.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：63 行
- 文件标识：`56ab7475bbd2`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::shockFluid::moveMesh` | 35 |
| `Foam::solvers::shockFluid::motionCorrector` | 44 |
