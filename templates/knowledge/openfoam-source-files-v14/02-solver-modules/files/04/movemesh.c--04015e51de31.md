...
slug: "openfoam-v14-file-04015e51de31"
...
source_path: "applications/modules/incompressibleFluid/moveMesh.C"
...
- 源码路径：`applications/modules/incompressibleFluid/moveMesh.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：84 行
- 文件标识：`04015e51de31`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::incompressibleFluid::moveMesh` | 37 |
| `Foam::solvers::incompressibleFluid::motionCorrector` | 46 |
