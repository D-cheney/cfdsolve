...
slug: "openfoam-v14-file-8708e014389d"
title: "OpenFOAM 14 源码解析：pressureCorrector.C"
summary: "该文件实现 `incompressiblePressureCorrector` 等过程，属于“模块化求解器”模块。"
...
source_path: "applications/modules/twoPhaseSolver/pressureCorrector.C"
...
- 源码路径：`applications/modules/twoPhaseSolver/pressureCorrector.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：157 行
- 文件标识：`8708e014389d`
...
该文件实现 `incompressiblePressureCorrector` 等过程，属于“模块化求解器”模块。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::twoPhaseSolver::incompressiblePressureCorrector` | 46 |
