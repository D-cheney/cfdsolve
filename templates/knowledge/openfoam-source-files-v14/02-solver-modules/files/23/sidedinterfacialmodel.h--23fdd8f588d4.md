...
slug: "openfoam-v14-file-23fdd8f588d4"
title: "OpenFOAM 14 源码解析：SidedInterfacialModel.H"
summary: "该文件实现 `SidedInterfacialModel` 相关对象的读取、写出或流序列化。"
...
source_path: "applications/modules/multiphaseEuler/phaseSystem/interfacialModels/SidedInterfacialModel/SidedInterfacialModel.H"
tags: [OpenFOAM14, 源码解析, 模块化求解器]
---

# OpenFOAM 14 源码解析：SidedInterfacialModel.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/modules/multiphaseEuler/phaseSystem/interfacialModels/SidedInterfacialModel/SidedInterfacialModel.H`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：168 行
- 文件标识：`23fdd8f588d4`
...
该文件实现 `SidedInterfacialModel` 相关对象的读取、写出或流序列化。

中文导航角色：模块化求解器实现。

上游说明：Wrapper class for interfacial models for which two instances of the model are used per interface; one for each side of the interface

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `SidedInterfacialModel` | 56 |
...
- [`SidedInterfacialModel.C`](../../../02-solver-modules/files/49/sidedinterfacialmodel.c--49a370d8d218.md)
...
`TypeName`、`defineSidedInterfacialModelTypeNameAndDebug`
