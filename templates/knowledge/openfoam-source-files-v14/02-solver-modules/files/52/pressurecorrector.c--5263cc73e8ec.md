...
slug: "openfoam-v14-file-5263cc73e8ec"
...
source_path: "applications/modules/compressibleVoF/pressureCorrector.C"
...
- 源码路径：`applications/modules/compressibleVoF/pressureCorrector.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：233 行
- 文件标识：`5263cc73e8ec`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::compressibleVoF::pressureCorrector` | 46 |
...
8. **非正交校正**：在外层解不变的条件下重复修正非正交拉普拉斯贡献，并在末次更新守恒通量。
9. **压力速度耦合**：在动量预测、压力校正和外/内迭代之间协调场更新。
