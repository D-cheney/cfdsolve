...
slug: "openfoam-v14-file-feefb02c21b4"
...
source_path: "applications/modules/multiphaseEuler/moveMesh.C"
...
- 源码路径：`applications/modules/multiphaseEuler/moveMesh.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：95 行
- 文件标识：`feefb02c21b4`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::multiphaseEuler::moveMesh` | 37 |
| `Foam::solvers::multiphaseEuler::motionCorrector` | 64 |
