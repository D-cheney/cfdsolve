...
slug: "openfoam-v14-file-a0700a93d70e"
title: "OpenFOAM 14 源码解析：PrinceBlanch.C"
summary: "该文件实现 `PrinceBlanch` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "applications/modules/multiphaseEuler/populationBalance/coalescenceModels/PrinceBlanch/PrinceBlanch.C"
tags: [OpenFOAM14, 源码解析, 模块化求解器]
---

# OpenFOAM 14 源码解析：PrinceBlanch.C
...
该文件实现 `PrinceBlanch` 的运行时工厂选择，根据类型名创建具体实现。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::populationBalance::coalescenceModels::PrinceBlanch::precompute` | 100 |
| `Foam::populationBalance::coalescenceModels::PrinceBlanch::rate` | 109 |
...
- [`PrinceBlanch.H`](../../../02-solver-modules/files/13/princeblanch.h--138530a0a774.md)
