...
slug: "openfoam-v14-file-0c896edceeb8"
...
source_path: "applications/modules/shockFluid/thermophysicalPredictor.C"
...
- 源码路径：`applications/modules/shockFluid/thermophysicalPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：91 行
- 文件标识：`0c896edceeb8`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::shockFluid::thermophysicalPredictor` | 38 |
