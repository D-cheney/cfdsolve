...
slug: "openfoam-v14-file-ff733a56bae4"
title: "OpenFOAM 14 源码解析：thermophysicalPredictor.C"
summary: "该文件实现 `thermophysicalPredictor` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "applications/modules/XiFluid/thermophysicalPredictor.C"
tags: [OpenFOAM14, 源码解析, 模块化求解器]
---

# OpenFOAM 14 源码解析：thermophysicalPredictor.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/modules/XiFluid/thermophysicalPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：623 行
- 文件标识：`ff733a56bae4`
...
该文件实现 `thermophysicalPredictor` 的运行时工厂选择，根据类型名创建具体实现。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::XiFluid::burn` | 48 |
| `Foam::solvers::XiFluid::uSolve` | 252 |
| `Foam::solvers::XiFluid::bSolve` | 288 |
| `Foam::solvers::XiFluid::fvmStab` | 329 |
| `Foam::solvers::XiFluid::ubSolve` | 357 |
| `Foam::solvers::XiFluid::HuSolve` | 449 |
| `Foam::solvers::XiFluid::HbSolve` | 493 |
| `Foam::solvers::XiFluid::thermophysicalPredictor` | 540 |
...
10. **边界回写**：内部场更新后重新执行各 patch 的边界条件计算。
