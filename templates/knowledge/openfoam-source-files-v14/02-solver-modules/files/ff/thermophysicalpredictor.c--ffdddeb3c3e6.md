...
slug: "openfoam-v14-file-ffdddeb3c3e6"
title: "OpenFOAM 14 源码解析：thermophysicalPredictor.C"
summary: "该文件实现 `thermophysicalPredictor` 等过程，属于“模块化求解器”模块。"
...
source_path: "applications/modules/compressibleMultiphaseVoF/thermophysicalPredictor.C"
...
- 源码路径：`applications/modules/compressibleMultiphaseVoF/thermophysicalPredictor.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：71 行
- 文件标识：`ffdddeb3c3e6`
...
该文件实现 `thermophysicalPredictor` 等过程，属于“模块化求解器”模块。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::compressibleMultiphaseVoF::thermophysicalPredictor` | 40 |
