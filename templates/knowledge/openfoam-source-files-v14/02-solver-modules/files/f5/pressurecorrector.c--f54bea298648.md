...
slug: "openfoam-v14-file-f54bea298648"
...
source_path: "applications/modules/incompressibleMultiphaseVoF/pressureCorrector.C"
...
- 源码路径：`applications/modules/incompressibleMultiphaseVoF/pressureCorrector.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：155 行
- 文件标识：`f54bea298648`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::incompressibleMultiphaseVoF::pressureCorrector` | 46 |
