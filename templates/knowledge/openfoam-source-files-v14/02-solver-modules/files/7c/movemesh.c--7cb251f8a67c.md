...
slug: "openfoam-v14-file-7cb251f8a67c"
...
source_path: "applications/modules/isothermalFluid/moveMesh.C"
...
- 源码路径：`applications/modules/isothermalFluid/moveMesh.C`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：91 行
- 文件标识：`7cb251f8a67c`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::solvers::isothermalFluid::moveMesh` | 37 |
| `Foam::solvers::isothermalFluid::motionCorrector` | 46 |
