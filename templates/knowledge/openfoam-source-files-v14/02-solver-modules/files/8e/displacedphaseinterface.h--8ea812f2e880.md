...
slug: "openfoam-v14-file-8ea812f2e880"
title: "OpenFOAM 14 源码解析：displacedPhaseInterface.H"
summary: "该文件声明或实现 `displacedPhaseInterface`，属于“模块化求解器”模块。"
...
source_path: "applications/modules/multiphaseEuler/phaseSystem/phaseInterface/displacedPhaseInterface/displacedPhaseInterface.H"
tags: [OpenFOAM14, 源码解析, 模块化求解器]
---

# OpenFOAM 14 源码解析：displacedPhaseInterface.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/modules/multiphaseEuler/phaseSystem/phaseInterface/displacedPhaseInterface/displacedPhaseInterface.H`
- 功能分类：模块化求解器
- 文件类型：C/C++ 或词法/语法源文件
- 规模：134 行
- 文件标识：`8ea812f2e880`
...
该文件声明或实现 `displacedPhaseInterface`，属于“模块化求解器”模块。

中文导航角色：模块化求解器实现。

上游说明：Class to represent an interface between phases which has been displaced to some extent by a third phase.

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `displacedPhaseInterface` | 55 |
...
- [applications/modules/multiphaseEuler/phaseSystem/phaseInterface/displacedPhaseInterface/displacedPhaseInterface.C](../../../02-solver-modules/files/6b/displacedphaseinterface.c--6bbb0c37c9ae.md)
