...
slug: "openfoam-v14-file-50c8bb620c7a"
...
source_path: "src/twoPhaseModels/compressibleCavitation/Merkle/Merkle.H"
...
- 源码路径：`src/twoPhaseModels/compressibleCavitation/Merkle/Merkle.H`
- 功能分类：多相与界面
- 文件类型：C/C++ 或词法/语法源文件
- 规模：172 行
- 文件标识：`50c8bb620c7a`
