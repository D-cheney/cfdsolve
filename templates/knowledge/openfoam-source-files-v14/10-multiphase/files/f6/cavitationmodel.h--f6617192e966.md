...
slug: "openfoam-v14-file-f6617192e966"
...
source_path: "src/twoPhaseModels/compressibleCavitation/cavitationModel/cavitationModel.H"
...
- 源码路径：`src/twoPhaseModels/compressibleCavitation/cavitationModel/cavitationModel.H`
- 功能分类：多相与界面
- 文件类型：C/C++ 或词法/语法源文件
- 规模：228 行
- 文件标识：`f6617192e966`
