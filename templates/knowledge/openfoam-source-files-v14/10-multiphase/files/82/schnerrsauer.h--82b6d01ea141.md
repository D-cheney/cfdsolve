...
slug: "openfoam-v14-file-82b6d01ea141"
...
source_path: "src/twoPhaseModels/compressibleCavitation/SchnerrSauer/SchnerrSauer.H"
...
- 源码路径：`src/twoPhaseModels/compressibleCavitation/SchnerrSauer/SchnerrSauer.H`
- 功能分类：多相与界面
- 文件类型：C/C++ 或词法/语法源文件
- 规模：185 行
- 文件标识：`82b6d01ea141`
