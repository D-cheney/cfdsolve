...
slug: "openfoam-v14-file-0a9502bc208e"
title: "OpenFOAM 14 源码解析：lduInterfaceFieldPtrsList.H"
summary: "该文件为“矩阵与线性求解”提供 `lduInterfaceFieldPtrsList` 相关接口、模板实例或支撑定义。"
...
source_path: "src/OpenFOAM/matrices/lduMatrix/lduAddressing/lduInterfaceFields/lduInterfaceField/lduInterfaceFieldPtrsList.H"
...
- 源码路径：`src/OpenFOAM/matrices/lduMatrix/lduAddressing/lduInterfaceFields/lduInterfaceField/lduInterfaceFieldPtrsList.H`
- 功能分类：矩阵与线性求解
- 文件类型：C/C++ 或词法/语法源文件
- 规模：55 行
- 文件标识：`0a9502bc208e`
...
该文件为“矩阵与线性求解”提供 `lduInterfaceFieldPtrsList` 相关接口、模板实例或支撑定义。
