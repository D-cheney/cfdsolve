...
slug: "openfoam-v14-file-c8a97b2d8f38"
title: "OpenFOAM 14 源码解析：lduMatrix.C"
summary: "该文件实现 `lduMatrix`、`lower`、`diag`、`upper` 等过程，属于“矩阵与线性求解”模块。"
...
该文件实现 `lduMatrix`、`lower`、`diag`、`upper` 等过程，属于“矩阵与线性求解”模块。
...
| 名称 | 源码行 |
|---|---:|
| `Foam::lduMatrix::lduMatrix` | 56 |
| `Foam::lduMatrix::lower` | 172 |
| `Foam::lduMatrix::diag` | 190 |
| `Foam::lduMatrix::upper` | 201 |
