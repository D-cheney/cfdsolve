...
slug: "openfoam-v14-file-20d36b6e5101"
title: "OpenFOAM 14 源码解析：LamBremhorstKE.C"
summary: "该文件为“湍流与输运”提供 `LamBremhorstKE` 相关接口、模板实例或支撑定义。"
...
source_path: "src/MomentumTransportModels/incompressible/RAS/LamBremhorstKE/LamBremhorstKE.C"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：LamBremhorstKE.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/incompressible/RAS/LamBremhorstKE/LamBremhorstKE.C`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：254 行
- 文件标识：`20d36b6e5101`
...
该文件为“湍流与输运”提供 `LamBremhorstKE` 相关接口、模板实例或支撑定义。
...
- [`LamBremhorstKE.H`](../../../09-turbulence-transport/files/e6/lambremhorstke.h--e61ef24883a0.md)
