...
slug: "openfoam-v14-file-86bad486460a"
title: "OpenFOAM 14 源码解析：Maxwell.C"
summary: "该文件实现 `Maxwell` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/MomentumTransportModels/momentumTransportModels/laminar/Maxwell/Maxwell.C"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：Maxwell.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/momentumTransportModels/laminar/Maxwell/Maxwell.C`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：455 行
- 文件标识：`86bad486460a`
...
该文件实现 `Maxwell` 的运行时工厂选择，根据类型名创建具体实现。
