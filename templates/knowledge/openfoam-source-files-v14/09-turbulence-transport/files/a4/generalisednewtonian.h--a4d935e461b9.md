...
slug: "openfoam-v14-file-a4d935e461b9"
title: "OpenFOAM 14 源码解析：generalisedNewtonian.H"
summary: "该文件声明或实现 `generalisedNewtonian`，属于“湍流与输运”模块。"
...
source_path: "src/MomentumTransportModels/momentumTransportModels/laminar/generalisedNewtonian/generalisedNewtonian.H"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：generalisedNewtonian.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/momentumTransportModels/laminar/generalisedNewtonian/generalisedNewtonian.H`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：153 行
- 文件标识：`a4d935e461b9`
...
该文件声明或实现 `generalisedNewtonian`，属于“湍流与输运”模块。

中文导航角色：层流/RANS/LES 动量输运模型。

上游说明：Momentum transport model for shear-dependent Non-Newtonian flow.

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `generalisedNewtonian` | 58 |
...
- [`generalisedNewtonian.C`](../../../09-turbulence-transport/files/e7/generalisednewtonian.c--e7e4b6df6906.md)
...
- [src/MomentumTransportModels/momentumTransportModels/laminar/generalisedNewtonian/generalisedNewtonian.C](../../../09-turbulence-transport/files/e7/generalisednewtonian.c--e7e4b6df6906.md)
