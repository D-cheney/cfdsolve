...
slug: "openfoam-v14-file-8d88e13d7935"
title: "OpenFOAM 14 源码解析：PTT.H"
summary: "该文件声明或实现 `PTT`，属于“湍流与输运”模块。"
...
source_path: "src/MomentumTransportModels/momentumTransportModels/laminar/PTT/PTT.H"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：PTT.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/momentumTransportModels/laminar/PTT/PTT.H`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：154 行
- 文件标识：`8d88e13d7935`
...
该文件声明或实现 `PTT`，属于“湍流与输运”模块。

中文导航角色：层流/RANS/LES 动量输运模型。

上游说明：PTT model for viscoelasticity using the upper-convected time derivative of the stress tensor with support for multiple modes. Reference: \verbatim Phan-Thien, N., & Tanner, R. I. (1977). A new constitutive equation derived from network theory. Journal of Non-Newtonian Fluid Mechanics, 2(4), 353-365. \endverbatim
...
- [`PTT.C`](../../../09-turbulence-transport/files/17/ptt.c--172bf40dbdc7.md)
...
- [src/MomentumTransportModels/momentumTransportModels/laminar/PTT/PTT.C](../../../09-turbulence-transport/files/17/ptt.c--172bf40dbdc7.md)
