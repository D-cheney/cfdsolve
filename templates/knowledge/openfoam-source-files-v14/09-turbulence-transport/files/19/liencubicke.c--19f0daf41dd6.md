...
slug: "openfoam-v14-file-19f0daf41dd6"
title: "OpenFOAM 14 源码解析：LienCubicKE.C"
summary: "该文件为“湍流与输运”提供 `LienCubicKE` 相关接口、模板实例或支撑定义。"
...
source_path: "src/MomentumTransportModels/incompressible/RAS/LienCubicKE/LienCubicKE.C"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：LienCubicKE.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/incompressible/RAS/LienCubicKE/LienCubicKE.C`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：322 行
- 文件标识：`19f0daf41dd6`
...
该文件为“湍流与输运”提供 `LienCubicKE` 相关接口、模板实例或支撑定义。
...
- [`LienCubicKE.H`](../../../09-turbulence-transport/files/c4/liencubicke.h--c4b18c802c1f.md)
