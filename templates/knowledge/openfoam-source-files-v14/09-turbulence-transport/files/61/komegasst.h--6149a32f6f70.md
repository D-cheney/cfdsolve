...
slug: "openfoam-v14-file-6149a32f6f70"
title: "OpenFOAM 14 源码解析：kOmegaSST.H"
summary: "该文件声明或实现 `kOmegaSST`，属于“湍流与输运”模块。"
...
source_path: "src/MomentumTransportModels/momentumTransportModels/RAS/kOmegaSST/kOmegaSST.H"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：kOmegaSST.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/momentumTransportModels/RAS/kOmegaSST/kOmegaSST.H`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：117 行
- 文件标识：`6149a32f6f70`
...
该文件声明或实现 `kOmegaSST`，属于“湍流与输运”模块。

中文导航角色：层流/RANS/LES 动量输运模型。

上游说明：Specialisation for RAS of the generic kOmegaSSTBase base class. For more information, see Description of kOmegaSSTBase.H
...
- [`kOmegaSST.C`](../../../09-turbulence-transport/files/9f/komegasst.c--9fc6df91dcc0.md)
...
- [src/MomentumTransportModels/momentumTransportModels/RAS/kOmegaSST/kOmegaSST.C](../../../09-turbulence-transport/files/9f/komegasst.c--9fc6df91dcc0.md)
- [src/MomentumTransportModels/momentumTransportModels/RAS/kOmegaSSTLM/kOmegaSSTLM.H](../../../09-turbulence-transport/files/b5/komegasstlm.h--b575eb9a5408.md)
