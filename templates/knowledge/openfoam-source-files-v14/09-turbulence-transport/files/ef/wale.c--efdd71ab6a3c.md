...
slug: "openfoam-v14-file-efdd71ab6a3c"
title: "OpenFOAM 14 源码解析：WALE.C"
summary: "该文件实现 `WALE` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "src/MomentumTransportModels/momentumTransportModels/LES/WALE/WALE.C"
tags: [OpenFOAM14, 源码解析, 湍流与输运]
---

# OpenFOAM 14 源码解析：WALE.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/MomentumTransportModels/momentumTransportModels/LES/WALE/WALE.C`
- 功能分类：湍流与输运
- 文件类型：C/C++ 或词法/语法源文件
- 规模：171 行
- 文件标识：`efdd71ab6a3c`
...
该文件实现 `WALE` 的运行时工厂选择，根据类型名创建具体实现。
