...
slug: "openfoam-v14-file-deb811b07a55"
...
source_path: "applications/utilities/preProcessing/boxTurb/createFields.H"
...
- 源码路径：`applications/utilities/preProcessing/boxTurb/createFields.H`
- 功能分类：前后处理工具
- 文件类型：C/C++ 或词法/语法源文件
- 规模：20 行
- 文件标识：`deb811b07a55`
