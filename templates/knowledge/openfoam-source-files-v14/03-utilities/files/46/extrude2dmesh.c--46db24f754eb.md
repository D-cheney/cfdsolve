...
slug: "openfoam-v14-file-46db24f754eb"
title: "OpenFOAM 14 源码解析：extrude2DMesh.C"
...
source_path: "applications/utilities/mesh/generation/extrude2DMesh/extrude2DMesh.C"
tags: [OpenFOAM14, 源码解析, 前后处理工具]
---

# OpenFOAM 14 源码解析：extrude2DMesh.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/utilities/mesh/generation/extrude2DMesh/extrude2DMesh.C`
- 功能分类：前后处理工具
- 文件类型：C/C++ 或词法/语法源文件
- 规模：291 行
- 文件标识：`46db24f754eb`
...
上游说明：Takes 2D mesh (all faces 2 points only, no front and back faces) and creates a 3D mesh by extruding with specified thickness. Note: Not sure about the walking of the faces to create the front and back faces.
...
- [`extrude2DMesh.H`](../../../03-utilities/files/8a/extrude2dmesh.h--8ab58bda6cbd.md)
