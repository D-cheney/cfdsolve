...
slug: "openfoam-v14-file-8deeaf3954bb"
...
source_path: "applications/utilities/preProcessing/applyBoundaryLayer/createFields.H"
...
- 源码路径：`applications/utilities/preProcessing/applyBoundaryLayer/createFields.H`
- 功能分类：前后处理工具
- 文件类型：C/C++ 或词法/语法源文件
- 规模：83 行
- 文件标识：`8deeaf3954bb`
