...
slug: "openfoam-v14-file-502147f39ac9"
...
source_path: "applications/utilities/mesh/conversion/plot3dToFoam/hexBlock.H"
...
- 源码路径：`applications/utilities/mesh/conversion/plot3dToFoam/hexBlock.H`
- 功能分类：前后处理工具
- 文件类型：C/C++ 或词法/语法源文件
- 规模：172 行
- 文件标识：`502147f39ac9`
...
上游说明：\*---------------------------------------------------------------------------*/ #ifndef hexBlock_H #define hexBlock_H #include "labelList.H" #include "pointField.H" #include "faceList.H" // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * // namespace Foam { /*---------------------------------------------------------------------------*\ Class hexBlock Declaration
