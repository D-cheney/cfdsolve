...
slug: "openfoam-v14-file-e8219e4a5d6b"
...
source_path: "applications/utilities/postProcessing/dataConversion/foamToVTK/foamToVTK/readFields.H"
...
- 源码路径：`applications/utilities/postProcessing/dataConversion/foamToVTK/foamToVTK/readFields.H`
- 功能分类：前后处理工具
- 文件类型：C/C++ 或词法/语法源文件
- 规模：76 行
- 文件标识：`e8219e4a5d6b`
