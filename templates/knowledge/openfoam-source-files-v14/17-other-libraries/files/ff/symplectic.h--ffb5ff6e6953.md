...
slug: "openfoam-v14-file-ffb5ff6e6953"
...
source_path: "src/rigidBodyMotion/sixDoFRigidBodyMotion/sixDoFSolvers/symplectic/symplectic.H"
...
- 源码路径：`src/rigidBodyMotion/sixDoFRigidBodyMotion/sixDoFSolvers/symplectic/symplectic.H`
- 功能分类：其他物理与支撑库
- 文件类型：C/C++ 或词法/语法源文件
- 规模：129 行
- 文件标识：`ffb5ff6e6953`
