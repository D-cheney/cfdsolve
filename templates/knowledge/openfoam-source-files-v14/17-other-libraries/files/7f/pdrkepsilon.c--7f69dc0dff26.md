...
slug: "openfoam-v14-file-7f69dc0dff26"
title: "OpenFOAM 14 源码解析：PDRkEpsilon.C"
summary: "该文件实现 `PDRkEpsilon` 的运行时工厂选择，根据类型名创建具体实现。"
...
source_path: "applications/legacy/combustion/PDRFoam/PDRModels/turbulence/PDRkEpsilon/PDRkEpsilon.C"
tags: [OpenFOAM14, 源码解析, 其他物理与支撑库]
---

# OpenFOAM 14 源码解析：PDRkEpsilon.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/legacy/combustion/PDRFoam/PDRModels/turbulence/PDRkEpsilon/PDRkEpsilon.C`
- 功能分类：其他物理与支撑库
- 文件类型：C/C++ 或词法/语法源文件
- 规模：209 行
- 文件标识：`7f69dc0dff26`
...
该文件实现 `PDRkEpsilon` 的运行时工厂选择，根据类型名创建具体实现。
...
- [`PDRkEpsilon.H`](../../../17-other-libraries/files/a4/pdrkepsilon.h--a408d12c8c6c.md)
