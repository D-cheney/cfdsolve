...
slug: "openfoam-v14-file-28b265a1b728"
...
source_path: "src/rigidBodyMotion/rigidBodyDynamics/rigidBodySolvers/Newmark/Newmark.H"
...
- 源码路径：`src/rigidBodyMotion/rigidBodyDynamics/rigidBodySolvers/Newmark/Newmark.H`
- 功能分类：其他物理与支撑库
- 文件类型：C/C++ 或词法/语法源文件
- 规模：130 行
- 文件标识：`28b265a1b728`
