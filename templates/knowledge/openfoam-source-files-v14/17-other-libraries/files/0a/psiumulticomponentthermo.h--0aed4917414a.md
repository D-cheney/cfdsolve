...
slug: "openfoam-v14-file-0aed4917414a"
title: "OpenFOAM 14 源码解析：PsiuMulticomponentThermo.H"
summary: "该文件声明或实现 `PsiuMulticomponentThermo`，属于“其他物理与支撑库”模块。"
...
该文件声明或实现 `PsiuMulticomponentThermo`，属于“其他物理与支撑库”模块。
...
- [`PsiuMulticomponentThermo.C`](../../../17-other-libraries/files/b6/psiumulticomponentthermo.c--b626a4374bbd.md)
