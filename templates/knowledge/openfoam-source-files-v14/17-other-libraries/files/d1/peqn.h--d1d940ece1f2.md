...
slug: "openfoam-v14-file-d1d940ece1f2"
...
source_path: "applications/legacy/incompressible/porousSimpleFoam/pEqn.H"
...
- 源码路径：`applications/legacy/incompressible/porousSimpleFoam/pEqn.H`
- 功能分类：其他物理与支撑库
- 文件类型：C/C++ 或词法/语法源文件
- 规模：69 行
- 文件标识：`d1d940ece1f2`
