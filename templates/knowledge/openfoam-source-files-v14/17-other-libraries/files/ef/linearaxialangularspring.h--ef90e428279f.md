...
slug: "openfoam-v14-file-ef90e428279f"
...
source_path: "src/rigidBodyMotion/sixDoFRigidBodyMotion/sixDoFRigidBodyMotion/restraints/linearAxialAngularSpring/linearAxialAngularSpring.H"
...
- 源码路径：`src/rigidBodyMotion/sixDoFRigidBodyMotion/sixDoFRigidBodyMotion/restraints/linearAxialAngularSpring/linearAxialAngularSpring.H`
- 功能分类：其他物理与支撑库
- 文件类型：C/C++ 或词法/语法源文件
- 规模：137 行
- 文件标识：`ef90e428279f`
...
上游说明：sixDoFRigidBodyMotionRestraints model. Linear axial angular spring.

## 3. 主要类型

| 名称 | 源码行 |
|---|---:|
| `linearAxialAngularSpring` | 59 |
