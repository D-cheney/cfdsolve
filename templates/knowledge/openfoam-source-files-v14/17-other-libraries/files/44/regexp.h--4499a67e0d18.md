...
slug: "openfoam-v14-file-4499a67e0d18"
title: "OpenFOAM 14 源码解析：regExp.H"
summary: "该文件声明或实现 `string`、`List`、`regExp`，属于“其他物理与支撑库”模块。"
...
source_path: "src/OSspecific/POSIX/regExp.H"
tags: [OpenFOAM14, 源码解析, 其他物理与支撑库]
---

# OpenFOAM 14 源码解析：regExp.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/OSspecific/POSIX/regExp.H`
- 功能分类：其他物理与支撑库
- 文件类型：C/C++ 或词法/语法源文件
- 规模：216 行
- 文件标识：`4499a67e0d18`
...
该文件声明或实现 `string`、`List`、`regExp`，属于“其他物理与支撑库”模块。

中文导航角色：OpenFOAM 支撑代码。

上游说明：Wrapper around POSIX extended regular expressions. The PCRE '(?i)' extension is provided to compile the regular expression as being case-insensitive.
