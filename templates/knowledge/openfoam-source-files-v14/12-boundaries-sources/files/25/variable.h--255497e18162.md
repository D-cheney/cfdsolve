...
slug: "openfoam-v14-file-255497e18162"
title: "OpenFOAM 14 源码解析：variable.H"
summary: "该文件声明或实现 `variable`，属于“边界、源项与约束”模块。"
...
source_path: "src/fvModels/interRegion/heatTransferCoefficientModels/variable/variable.H"
...
- 源码路径：`src/fvModels/interRegion/heatTransferCoefficientModels/variable/variable.H`
- 功能分类：边界、源项与约束
- 文件类型：C/C++ 或词法/语法源文件
- 规模：167 行
- 文件标识：`255497e18162`
...
该文件声明或实现 `variable`，属于“边界、源项与约束”模块。
