...
slug: "openfoam-v14-file-988d89ddc8d3"
title: "OpenFOAM 14 源码解析：ThermoRefPairI.H"
summary: "该文件为“边界、源项与约束”提供 `ThermoRefPairI` 相关接口、模板实例或支撑定义。"
...
source_path: "src/fvModels/general/phaseChange/ThermoRefPairI.H"
tags: [OpenFOAM14, 源码解析, 边界、源项与约束]
---

# OpenFOAM 14 源码解析：ThermoRefPairI.H

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`src/fvModels/general/phaseChange/ThermoRefPairI.H`
- 功能分类：边界、源项与约束
- 文件类型：C/C++ 或词法/语法源文件
- 规模：189 行
- 文件标识：`988d89ddc8d3`
...
该文件为“边界、源项与约束”提供 `ThermoRefPairI` 相关接口、模板实例或支撑定义。
