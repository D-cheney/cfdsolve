...
slug: "openfoam-v14-file-e46558241789"
title: "OpenFOAM 14 源码解析：regionSolvers.C"
...
source_path: "applications/solvers/foamMultiRun/regionSolvers/regionSolvers.C"
tags: [OpenFOAM14, 源码解析, 求解器入口]
---

# OpenFOAM 14 源码解析：regionSolvers.C

> 本页由静态分析生成，再按可识别的 OpenFOAM 模式补充中文算法说明。它用于源码导航，不替代编译、调试和算例验证。

## 1. 文件定位

- 源码路径：`applications/solvers/foamMultiRun/regionSolvers/regionSolvers.C`
- 功能分类：求解器入口
- 文件类型：C/C++ 或词法/语法源文件
- 规模：212 行
- 文件标识：`e46558241789`
...
| 名称 | 源码行 |
|---|---:|
| `Foam::regionSolvers::setGlobalPrefix` | 184 |
| `Foam::regionSolvers::setPrefix` | 189 |
| `Foam::regionSolvers::resetPrefix` | 195 |
