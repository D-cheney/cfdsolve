...
slug: "openfoam-v14-file-37bcb1acc2af"
...
source_path: "applications/solvers/potentialFoam/createFields.H"
...
- 源码路径：`applications/solvers/potentialFoam/createFields.H`
- 功能分类：求解器入口
- 文件类型：C/C++ 或词法/语法源文件
- 规模：129 行
- 文件标识：`37bcb1acc2af`
