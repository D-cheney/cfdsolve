...
slug: "openfoam-v14-file-ff3507db4956"
title: "OpenFOAM 14 源码解析：pEqn.H"
summary: "这是一个可执行程序入口，负责准备运行环境并调度 `pEqn` 对应的工作流。"
...
source_path: "applications/solvers/chemFoam/pEqn.H"
...
- 源码路径：`applications/solvers/chemFoam/pEqn.H`
- 功能分类：求解器入口
- 文件类型：C/C++ 或词法/语法源文件
- 规模：22 行
- 文件标识：`ff3507db4956`
...
这是一个可执行程序入口，负责准备运行环境并调度 `pEqn` 对应的工作流。
