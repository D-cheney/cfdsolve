...
电磁热耦合的设置顺序与多数多物理场相反：应当先算电磁、再定热网格，因为导体内的热源密度完全由电流密度与频率决定，而频率又通过趋肤深度决定电磁网格的最小尺寸。电磁热耦合的典型流程是电磁求解器算出损耗密度，热求解器据此算温度场，再把温度回代修正电导率。这类结果最容易被两类伪影污染：把趋肤效应算成体积均匀损耗，以及把温度反馈迭代的未收敛当作稳态。
...
7. Ida N., Bastos J.P.A., *Electromagnetics and Calculation of Fields*, 2nd ed., Springer, 1997.
8. Biro O., Preis K., "On the use of the magnetic vector potential in the finite element analysis of three-dimensional eddy currents," *IEEE Transactions on Magnetics*, 25(4), 1989.
9. Incropera F.P., DeWitt D.P., Bergman T.L., Lavine A.S., *Fundamentals of Heat and Mass Transfer*, 7th ed., Wiley, 2011.
10. Meeker D., *Finite Element Method Magnetics: User's Manual*, 2019.
11. IEC 60287-1-1, *Electric cables — Calculation of the current rating — Part 1-1: Current rating equations and calculation of losses*, 2014.
12. Bungartz H.-J., Schäfer M. (eds.), *Fluid-Structure Interaction: Modelling, Simulation, Optimisation*, Springer, 2006.
