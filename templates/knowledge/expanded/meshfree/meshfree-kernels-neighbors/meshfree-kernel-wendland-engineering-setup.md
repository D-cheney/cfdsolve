...
title: "Wendland 核：工程设置与参数选择"
summary: "梳理 Wendland C2 核两套等价写法的常数配对关系，给出 1D/2D/3D 归一化常数、导数形式与邻居数预算，并用一个把 η 误当两倍导致邻居数从 58 掉到 7.2 的算例说明配置陷阱。"
category:
...
seo:
  title: "Wendland 核：工程设置与参数选择"
  description: "梳理 Wendland C2 核两套等价写法的常数配对关系，给出 1D/2D/3D 归一化常数、导数形式与邻居数预算，并用一个把 η 误当两倍导致邻居数从 58 掉到 7.2 的算例说明配置陷阱。"
  keywords:
    - "Wendland 核"
    - "工程设置与参数选择"
    - "正定性"
